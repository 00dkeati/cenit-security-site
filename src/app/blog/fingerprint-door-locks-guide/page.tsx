...
export const metadata: Metadata = {
  title: 'Fingerprint Door Locks: Complete Buyers Guide | Cenit Security Doors',
  description: 'Expert guide: fingerprint door locks: complete buyers guide. Professional security door advice from Costa del Sol specialists.',
  keywords: 'fingerprint door locks: complete buyers guide, security doors spain, costa del sol security',
};

export default function FingerprintDoorLocksGuidePage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Fingerprint Door Locks: Complete Buyers Guide
          </h1>
