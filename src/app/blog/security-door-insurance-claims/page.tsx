...
export const metadata: Metadata = {
  title: 'Security Door Documentation for Insurance | Cenit Security Doors',
  description: 'Expert guide: security door documentation for insurance. Professional security door advice from Costa del Sol specialists.',
  keywords: 'security door documentation for insurance, security doors spain, costa del sol security',
};

export default function SecurityDoorInsuranceClaimsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Security Door Documentation for Insurance
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about security door documentation for insurance.
            </p>
