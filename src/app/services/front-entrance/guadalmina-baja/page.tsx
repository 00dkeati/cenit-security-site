...
export const metadata: Metadata = {
  title: 'Front Entrance Doors Guadalmina Baja | Cenit Security',
  description: 'Professional front entrance doors installation in Guadalmina Baja, San Pedro de Alcántara. Bespoke security solutions for luxury properties.',
  keywords: 'front entrance doors guadalmina baja, security doors guadalmina baja, san pedro de alcántara security',
};

export default function FrontEntranceGuadalminaBajaPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Front Entrance Doors Solutions for Guadalmina Baja
          </h2>
