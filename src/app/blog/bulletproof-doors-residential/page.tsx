...
export const metadata: Metadata = {
  title: 'Bulletproof Doors for Residential Properties | Cenit Security Doors',
  description: 'Expert guide: bulletproof doors for residential properties. Professional security door advice from Costa del Sol specialists.',
  keywords: 'bulletproof doors for residential properties, security doors spain, costa del sol security',
};

export default function BulletproofDoorsResidentialPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Bulletproof Doors for Residential Properties
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about bulletproof doors for residential properties.
            </p>
