...
export const metadata: Metadata = {
  title: 'Laminated vs Tempered Security Glass | Cenit Security Doors',
  description: 'Expert guide: laminated vs tempered security glass. Professional security door advice from Costa del Sol specialists.',
  keywords: 'laminated vs tempered security glass, security doors spain, costa del sol security',
};

export default function LaminatedGlassVsTemperedPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Laminated vs Tempered Security Glass
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about laminated vs tempered security glass.
            </p>
