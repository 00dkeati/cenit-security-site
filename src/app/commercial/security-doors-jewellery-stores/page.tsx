...
export const metadata: Metadata = {
  title: 'Security Doors for Jewellery Stores | Cenit Security Costa del Sol',
  description: 'Security Doors for Jewellery Stores - specialist commercial security solutions for Costa del Sol businesses. Professional installation.',
  keywords: 'security doors for jewellery stores, commercial security doors, costa del sol business security',
};

export default function SecurityDoorsJewelleryStoresPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-8">
          Security Doors for Jewellery Stores
        </h1>
        
        <div className="prose prose-invert prose-lg max-w-none">
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            Specialist security solutions designed for the unique requirements of 
            retail businesses on the Costa del Sol. We understand the 
          ...
          <p className="text-gray-300 mb-4">
            Our experience working with retail clients across the Costa del Sol 
