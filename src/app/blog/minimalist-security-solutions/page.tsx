...
export const metadata: Metadata = {
  title: 'Minimalist Security: Less Visible Protection | Cenit Security Doors',
  description: 'Expert guide: minimalist security: less visible protection. Professional security door advice from Costa del Sol specialists.',
  keywords: 'minimalist security: less visible protection, security doors spain, costa del sol security',
};

export default function MinimalistSecuritySolutionsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Minimalist Security: Less Visible Protection
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about minimalist security: less visible protection.
            </p>
