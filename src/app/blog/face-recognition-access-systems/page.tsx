...
export const metadata: Metadata = {
  title: 'Face Recognition Access Systems for Homes | Cenit Security Doors',
  description: 'Expert guide: face recognition access systems for homes. Professional security door advice from Costa del Sol specialists.',
  keywords: 'face recognition access systems for homes, security doors spain, costa del sol security',
};

export default function FaceRecognitionAccessSystemsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Face Recognition Access Systems for Homes
          </h1>
