...
export const metadata: Metadata = {
  title: 'Security Solutions for Elderly Residents | Cenit Security Doors',
  description: 'Expert guide: security solutions for elderly residents. Professional security door advice from Costa del Sol specialists.',
  keywords: 'security solutions for elderly residents, security doors spain, costa del sol security',
};

export default function SecurityForElderlyResidentsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Security Solutions for Elderly Residents
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about security solutions for elderly residents.
            </p>
