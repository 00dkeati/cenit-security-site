...
export const metadata: Metadata = {
  title: 'Winter Property Protection When You Are Away | Cenit Security Doors',
  description: 'Expert guide: winter property protection when you are away. Professional security door advice from Costa del Sol specialists.',
  keywords: 'winter property protection when you are away, security doors spain, costa del sol security',
};

export default function WinterPropertyProtectionSpainPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Winter Property Protection When You Are Away
          </h1>
