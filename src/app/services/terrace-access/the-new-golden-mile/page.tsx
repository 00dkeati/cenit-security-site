...
export const metadata: Metadata = {
  title: 'Terrace Access Doors The New Golden Mile | Cenit Security',
  description: 'Professional terrace access doors installation in The New Golden Mile, Estepona. Bespoke security solutions for luxury properties.',
  keywords: 'terrace access doors the new golden mile, security doors the new golden mile, estepona security',
};

export default function TerraceAccessTheNewGoldenMilePage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Terrace Access Doors Solutions for The New Golden Mile
          </h2>
