...
export const metadata: Metadata = {
  title: 'Security Door Installation: Timeline & What to Expect | Cenit Security Doors',
  description: 'Expert guide: security door installation: timeline & what to expect. Professional security door advice from Costa del Sol specialists.',
  keywords: 'security door installation: timeline & what to expect, security doors spain, costa del sol security',
};

export default function SecurityDoorInstallationTimelinePage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Security Door Installation: Timeline & What to Expect
          </h1>
          
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              This comprehensive guide walks you through everything you need to know, from initial considerations to final decisions. Perfect for property owners who want thorough, reliable information.
            </p>
