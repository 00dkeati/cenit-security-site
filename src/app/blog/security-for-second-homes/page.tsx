...
export const metadata: Metadata = {
  title: 'Security Solutions for Second Home Owners | Cenit Security Doors',
  description: 'Expert guide: security solutions for second home owners. Professional security door advice from Costa del Sol specialists.',
  keywords: 'security solutions for second home owners, security doors spain, costa del sol security',
};

export default function SecurityForSecondHomesPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Security Solutions for Second Home Owners
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about security solutions for second home owners.
            </p>
