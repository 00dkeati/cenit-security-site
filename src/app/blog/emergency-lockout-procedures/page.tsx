...
export const metadata: Metadata = {
  title: 'Emergency Lockout Procedures for Security Doors | Cenit Security Doors',
  description: 'Expert guide: emergency lockout procedures for security doors. Professional security door advice from Costa del Sol specialists.',
  keywords: 'emergency lockout procedures for security doors, security doors spain, costa del sol security',
};

export default function EmergencyLockoutProceduresPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Emergency Lockout Procedures for Security Doors
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about emergency lockout procedures for security doors.
            </p>
