...
export const metadata: Metadata = {
  title: 'Security Doors FAQ Estepona | Cenit Security',
  description: 'Frequently asked questions about security doors in Estepona, Costa del Sol. Expert answers from Cenit Security.',
  keywords: 'security doors faq, estepona security, questions security doors',
};

export default function FAQEsteponaPage() {
  const faqs = [
    {
    ...
    },
    {
        ...
        "a": "Yes, we serve all areas of the Costa del Sol including Estepona and surrounding regions. Our team handles installations from Sotogrande to Málaga."
    },
    {
  ...
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h2 className="text-2xl text-gray-400 mb-12">Estepona, Costa del Sol</h2>
