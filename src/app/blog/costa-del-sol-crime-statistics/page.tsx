...
export const metadata: Metadata = {
  title: 'Costa del Sol Crime Statistics: What Property Owners Should Know | Cenit Security Doors',
  description: 'Expert guide: costa del sol crime statistics: what property owners should know. Professional security door advice from Costa del Sol specialists.',
  keywords: 'costa del sol crime statistics: what property owners should know, security doors spain, costa del sol security',
};

export default function CostaDelSolCrimeStatisticsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Costa del Sol Crime Statistics: What Property Owners Should Know
          </h1>
