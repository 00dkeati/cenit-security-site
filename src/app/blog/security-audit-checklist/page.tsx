...
export const metadata: Metadata = {
  title: 'Complete Security Audit Checklist for Villas | Cenit Security Doors',
  description: 'Expert guide: complete security audit checklist for villas. Professional security door advice from Costa del Sol specialists.',
  keywords: 'complete security audit checklist for villas, security doors spain, costa del sol security',
};
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Complete Security Audit Checklist for Villas
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about complete security audit checklist for villas.
            </p>
