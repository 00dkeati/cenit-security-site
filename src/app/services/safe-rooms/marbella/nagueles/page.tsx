...
export const metadata = {
  title: "Safe Rooms Nagüeles | Cenit Security Doors",
  description: "Safe Rooms & Panic Rooms for properties in Nagüeles, Marbella. Bespoke security engineering with discreet installation.",
};
    ...
    <main className="min-h-screen bg-[#0f0f0f] text-[#f5f0e8]">
      ...
      <section className="relative h-[60vh] flex items-end">
        <div className="absolute inset-0">
          <Image src="/doors/door-09.jpg" alt="Safe Rooms Nagüeles" fill className="object-cover" priority />
      ...
      <section className="py-20 px-8">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <p className="text-2xl font-light leading-relaxed text-[#f5f0e8]/90">
            Specialist safe rooms & panic rooms for Nagüeles properties.
          </p>
          <div className="text-lg text-[#f5f0e8]/70 leading-relaxed space-y-6">
            <p>
              Nagüeles is one of the most prestigious addresses in Marbella. Properties here demand safe rooms & panic rooms that match their exceptional standards.
            </p>
            <p>
              Cenit Security Doors provides bespoke safe rooms & panic rooms throughout Nagüeles, working with homeowners and architects to deliver solutions that integrate seamlessly with each property&apos;s unique character.
            </p>
            <p>
          ...
          <a 
            href="https://wa.me/34667793100?text=Hello%2C%20I%27m%20interested%20in%20safe%20rooms%20%26%20panic%20rooms%20for%20my%20property%20in%20Nag%C3%BCeles"
            target="_blank"
