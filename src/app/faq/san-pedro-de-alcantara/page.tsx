...
export const metadata: Metadata = {
  title: 'Security Doors FAQ San Pedro de Alcántara | Cenit Security',
  description: 'Frequently asked questions about security doors in San Pedro de Alcántara, Costa del Sol. Expert answers from Cenit Security.',
  keywords: 'security doors faq, san pedro de alcántara security, questions security doors',
};

export default function FAQSanPedroDeAlcantaraPage() {
  const faqs = [
    {
    ...
    },
    {
        ...
        "a": "Yes, we serve all areas of the Costa del Sol including San Pedro de Alcántara and surrounding regions. Our team handles installations from Sotogrande to Málaga."
    },
    {
  ...
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        <div className="mb-8">
          <Link href="/locations/san-pedro-de-alcantara" className="text-[#c9a961] hover:underline">
            ← Back to San Pedro de Alcántara
          </Link>
        </div>
        ...
        <h2 className="text-2xl text-gray-400 mb-12">San Pedro de Alcántara, Costa del Sol</h2>
        ...
        <div className="mt-12 p-8 bg-[#1a1a1a] rounded-lg border border-[#c9a961]/20">
          ...
          <p className="text-gray-300 mb-6">
            ...
            for your San Pedro de Alcántara property.
          </p>
          <a
