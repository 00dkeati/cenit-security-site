...
export const metadata = {
  title: "Biometric Access Control in Marbella | Cenit Security Doors",
  description: "Biometric Access Control for luxury properties in Marbella. London-standard security engineering with bespoke design and discreet installation.",
};

export default function BiometricAccessMarbellaPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-[#f5f0e8]">
      ...
      <section className="relative h-[60vh] flex items-end">
        <div className="absolute inset-0">
          <Image src="/doors/door-06.jpg" alt="Biometric Access in Marbella" fill className="object-cover" priority />
        ...
        <div className="relative z-10 w-full pb-16 px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-light">Biometric Access in Marbella</h1>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-3 gap-16">
          <div className="lg:col-span-2 space-y-8">
            ...
            <p className="text-2xl font-light leading-relaxed text-[#f5f0e8]/90">
              Specialist biometric access control for luxury properties throughout Marbella.
            </p>
            <div className="text-lg text-[#f5f0e8]/70 leading-relaxed space-y-6">
              <p>
                Cenit Security Doors provides bespoke biometric access control across Marbella, from initial consultation through to installation and commissioning. Our solutions are engineered to the highest standards whilst complementing the architectural character of your property.
              </p>
              <p>
                Marbella properties demand security solutions that match their prestige. We work with homeowners, architects, and developers to deliver biometric access control that provide certified protection without compromising on aesthetics.
              </p>
              <p>
                Every installation in Marbella is handled with complete discretion. Our team operates with minimal disruption to your household, and all technical specifications are documented with precision.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#1a1a1a] p-8">
              ...
              <p className="text-xl mb-4">Marbella</p>
              <Link href="/locations/marbella" className="text-[#c9a961] text-sm hover:underline">View area →</Link>
            </div>
            <a 
              href="https://wa.me/34667793100?text=Hello%2C%20I%27m%20interested%20in%20biometric%20access%20control%20for%20my%20property%20in%20Marbella"
              target="_blank"
