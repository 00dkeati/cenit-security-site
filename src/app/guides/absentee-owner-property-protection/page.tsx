...
export const metadata: Metadata = {
  title: 'Absentee Owner Property Protection Guide | Cenit Security Doors',
  description: 'Absentee Owner Property Protection Guide - comprehensive security guidance for Costa del Sol property owners from Cenit Security.',
  keywords: 'absentee owner property protection guide, property security, costa del sol, spain',
};

export default function AbsenteeOwnerPropertyProtectionPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-8">
          Absentee Owner Property Protection Guide
        </h1>
