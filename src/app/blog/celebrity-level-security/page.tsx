...
export const metadata: Metadata = {
  title: 'Celebrity-Level Security for Private Residences | Cenit Security Doors',
  description: 'Expert guide: celebrity-level security for private residences. Professional security door advice from Costa del Sol specialists.',
  keywords: 'celebrity-level security for private residences, security doors spain, costa del sol security',
};

export default function CelebrityLevelSecurityPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Celebrity-Level Security for Private Residences
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about celebrity-level security for private residences.
            </p>
