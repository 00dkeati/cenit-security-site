...
export const metadata: Metadata = {
  title: 'Glass Security Doors: Stylish Protection | Cenit Security Doors',
  description: 'Expert guide: glass security doors: stylish protection. Professional security door advice from Costa del Sol specialists.',
  keywords: 'glass security doors: stylish protection, security doors spain, costa del sol security',
};

export default function GlassSecurityDoorsOptionsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Glass Security Doors: Stylish Protection
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about glass security doors: stylish protection.
            </p>
