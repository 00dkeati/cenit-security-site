...
export const metadata: Metadata = {
  title: 'Security Options for Rustic Fincas | Cenit Security Doors',
  description: 'Expert guide: security options for rustic fincas. Professional security door advice from Costa del Sol specialists.',
  keywords: 'security options for rustic fincas, security doors spain, costa del sol security',
};

export default function RusticFincaSecurityOptionsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Security Options for Rustic Fincas
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about security options for rustic fincas.
            </p>
