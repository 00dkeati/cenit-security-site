...
export const metadata: Metadata = {
  title: 'Intercom Systems for Gated Properties | Cenit Security Doors',
  description: 'Expert guide: intercom systems for gated properties. Professional security door advice from Costa del Sol specialists.',
  keywords: 'intercom systems for gated properties, security doors spain, costa del sol security',
};

export default function IntercomSystemsGuidePage() {
  return (
        ...
        <article>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about intercom systems for gated properties.
            </p>
