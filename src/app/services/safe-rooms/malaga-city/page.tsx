...
export const metadata: Metadata = {
  title: 'Safe Room Installation Málaga City | Cenit Security',
  description: 'Professional safe room installation installation in Málaga City, Costa del Sol. Bespoke security solutions for luxury properties.',
  keywords: 'safe room installation málaga city, security doors málaga city, costa del sol security',
};

export default function SafeRoomsMalagaCityPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Safe Room Installation Solutions for Málaga City
          </h2>
