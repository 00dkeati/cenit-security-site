...
export const metadata: Metadata = {
  title: '5 Villa Security Mistakes and How to Avoid Them | Cenit Security Doors',
  description: 'Expert guide: 5 villa security mistakes and how to avoid them. Professional security door advice from Costa del Sol specialists.',
  keywords: '5 villa security mistakes and how to avoid them, security doors spain, costa del sol security',
};

export default function VillaSecurityMistakesPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            5 Villa Security Mistakes and How to Avoid Them
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about 5 villa security mistakes and how to avoid them.
            </p>
