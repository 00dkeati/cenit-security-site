...
export const metadata: Metadata = {
  title: 'Smart Locks vs Traditional Locks: Pros and Cons | Cenit Security Doors',
  description: 'Expert guide: smart locks vs traditional locks: pros and cons. Professional security door advice from Costa del Sol specialists.',
  keywords: 'smart locks vs traditional locks: pros and cons, security doors spain, costa del sol security',
};

export default function SmartLocksVsTraditionalLocksPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Smart Locks vs Traditional Locks: Pros and Cons
          </h1>
