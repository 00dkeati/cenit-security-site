...
export const metadata: Metadata = {
  title: 'Terrace Access Doors Los Reales | Cenit Security',
  description: 'Professional terrace access doors installation in Los Reales, Estepona. Bespoke security solutions for luxury properties.',
  keywords: 'terrace access doors los reales, security doors los reales, estepona security',
};

export default function TerraceAccessLosRealesPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Terrace Access Doors Solutions for Los Reales
          </h2>
