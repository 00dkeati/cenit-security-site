...
export const metadata = {
  title: "Safe Rooms in La Reserva, Sotogrande | Cenit Security Doors",
  description: "Safe Rooms & Panic Rooms for luxury properties in La Reserva. London-standard security engineering with bespoke design and discreet installation across Sotogrande.",
  keywords: "safe rooms & panic rooms, La Reserva, Sotogrande, security doors, Costa del Sol, luxury security",
};
    ...
    <main className="min-h-screen bg-[#0f0f0f] text-[#f5f0e8]">
      ...
      <section className="relative h-[60vh] flex items-end">
        <div className="absolute inset-0">
          <Image src="/doors/door-010.jpg" alt="Safe Rooms in La Reserva" fill className="object-cover" priority />
        ...
        <div className="relative z-10 w-full pb-16 px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-light">Safe Rooms in La Reserva</h1>
          ...
          <div className="grid lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2 space-y-8">
              ...
              <h2 className="text-3xl font-light leading-relaxed text-[#f5f0e8]/90">
                Expert Safe Rooms & Panic Rooms for La Reserva Properties
              </h2>
              <div className="text-lg text-[#f5f0e8]/70 leading-relaxed space-y-6">
                <p>For La Reserva's most discerning residents, a safe room provides the ultimate layer of protection. Whether safeguarding family members during emergencies or protecting high-value assets around the clock, our safe room installations deliver certified security with complete discretion.</p>
                <p>
            ...
            <div className="space-y-6">
              ...
              <a 
                href="https://wa.me/34667793100?text=Hello%2C%20I%27m%20interested%20in%20safe%20rooms%20%26%20panic%20rooms%20for%20my%20property%20in%20La%20Reserva%2C%20Sotogrande"
                target="_blank"
