...
export const metadata: Metadata = {
  title: 'Biometric Access Systems Puerto Banús | Cenit Security',
  description: 'Professional biometric access systems installation in Puerto Banús, Marbella. Bespoke security solutions for luxury properties.',
  keywords: 'biometric access systems puerto banús, security doors puerto banús, marbella security',
};

export default function BiometricAccessPuertoBanusPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Biometric Access Systems Solutions for Puerto Banús
          </h2>
