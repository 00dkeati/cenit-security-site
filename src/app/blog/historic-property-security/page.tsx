...
export const metadata: Metadata = {
  title: 'Security for Historic and Listed Properties | Cenit Security Doors',
  description: 'Expert guide: security for historic and listed properties. Professional security door advice from Costa del Sol specialists.',
  keywords: 'security for historic and listed properties, security doors spain, costa del sol security',
};

export default function HistoricPropertySecurityPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Security for Historic and Listed Properties
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about security for historic and listed properties.
            </p>
