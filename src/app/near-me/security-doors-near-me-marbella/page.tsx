...
export const metadata: Metadata = {
  title: 'Security Doors Near Me - Marbella Area | Cenit Security',
  description: 'Security Doors Near Me - Marbella Area. Professional security door installation and service. Free consultation available.',
  keywords: 'security doors near me - marbella area, security doors marbella, local security installer',
};

export default function SecurityDoorsNearMeMarbellaPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <p className="text-gray-300 mb-4">
            As a Marbella-based security company, we understand the specific needs 
          ...
          <p className="text-gray-300 mb-4">
            We've installed security doors throughout Marbella for villas, 
