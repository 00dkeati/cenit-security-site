...
export const metadata: Metadata = {
  title: 'Biometric Access Systems Bel Air | Cenit Security',
  description: 'Professional biometric access systems installation in Bel Air, Estepona. Bespoke security solutions for luxury properties.',
  keywords: 'biometric access systems bel air, security doors bel air, estepona security',
};

export default function BiometricAccessBelAirPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Biometric Access Systems Solutions for Bel Air
          </h2>
