...
export const metadata = {
  title: "Front Entrance Security Doors in Estepona | Cenit Security Doors",
  description: "Front Entrance Security Doors for luxury properties in Estepona. London-standard security engineering with bespoke design and discreet installation.",
};

export default function FrontEntranceEsteponaPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-[#f5f0e8]">
      ...
      <section className="relative h-[60vh] flex items-end">
        <div className="absolute inset-0">
          <Image src="/doors/door-07.jpg" alt="Front Entrance in Estepona" fill className="object-cover" priority />
        ...
        <div className="relative z-10 w-full pb-16 px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-light">Front Entrance in Estepona</h1>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-3 gap-16">
          <div className="lg:col-span-2 space-y-8">
            ...
            <p className="text-2xl font-light leading-relaxed text-[#f5f0e8]/90">
              Specialist front entrance security doors for luxury properties throughout Estepona.
            </p>
            <div className="text-lg text-[#f5f0e8]/70 leading-relaxed space-y-6">
              <p>
                Cenit Security Doors provides bespoke front entrance security doors across Estepona, from initial consultation through to installation and commissioning. Our solutions are engineered to the highest standards whilst complementing the architectural character of your property.
              </p>
              <p>
                Estepona properties demand security solutions that match their prestige. We work with homeowners, architects, and developers to deliver front entrance security doors that provide certified protection without compromising on aesthetics.
              </p>
              <p>
          ...
          <div className="space-y-6">
            ...
            <a 
              href="https://wa.me/34667793100?text=Hello%2C%20I%27m%20interested%20in%20front%20entrance%20security%20doors%20for%20my%20property%20in%20Estepona"
              target="_blank"
