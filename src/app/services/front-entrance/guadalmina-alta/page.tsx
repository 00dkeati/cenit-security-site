...
export const metadata: Metadata = {
  title: 'Front Entrance Doors Guadalmina Alta | Cenit Security',
  description: 'Professional front entrance doors installation in Guadalmina Alta, San Pedro de Alcántara. Bespoke security solutions for luxury properties.',
  keywords: 'front entrance doors guadalmina alta, security doors guadalmina alta, san pedro de alcántara security',
};

export default function FrontEntranceGuadalminaAltaPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Front Entrance Doors Solutions for Guadalmina Alta
          </h2>
