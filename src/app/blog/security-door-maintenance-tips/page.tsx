...
export const metadata: Metadata = {
  title: 'Security Door Maintenance: Keeping Your Investment Protected | Cenit Security Doors',
  description: 'Expert guide: security door maintenance: keeping your investment protected. Professional security door advice from Costa del Sol specialists.',
  keywords: 'security door maintenance: keeping your investment protected, security doors spain, costa del sol security',
};

export default function SecurityDoorMaintenanceTipsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Security Door Maintenance: Keeping Your Investment Protected
          </h1>
          
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              When it comes to protecting your property on the Costa del Sol, making informed decisions is crucial. This guide covers everything you need to know about security door maintenance: keeping your investment protected, helping you make the right choice for your home security needs.
            </p>
            ...
            <p className="text-gray-300 mb-4">
              Quality security doors require minimal maintenance but benefit from periodic inspection to ensure continued optimal performance.
            </p>
            <p className="text-gray-300 mb-4">
              Regular maintenance checks can identify potential issues before they become problems, extending the life of your security investment.
            </p>
