...
export const metadata: Metadata = {
  title: '10 Questions to Ask Your Security Door Installer | Cenit Security Doors',
  description: 'Expert guide: 10 questions to ask your security door installer. Professional security door advice from Costa del Sol specialists.',
  keywords: '10 questions to ask your security door installer, security doors spain, costa del sol security',
};

export default function QuestionsToAskSecurityInstallerPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            10 Questions to Ask Your Security Door Installer
          </h1>
