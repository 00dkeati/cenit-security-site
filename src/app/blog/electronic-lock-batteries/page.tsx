...
export const metadata: Metadata = {
  title: 'Electronic Lock Batteries: Maintenance Guide | Cenit Security Doors',
  description: 'Expert guide: electronic lock batteries: maintenance guide. Professional security door advice from Costa del Sol specialists.',
  keywords: 'electronic lock batteries: maintenance guide, security doors spain, costa del sol security',
};

export default function ElectronicLockBatteriesPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Electronic Lock Batteries: Maintenance Guide
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about electronic lock batteries: maintenance guide.
            </p>
