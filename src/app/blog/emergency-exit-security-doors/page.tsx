...
export const metadata: Metadata = {
  title: 'Emergency Exit Security Doors: Safety and Protection | Cenit Security Doors',
  description: 'Expert guide: emergency exit security doors: safety and protection. Professional security door advice from Costa del Sol specialists.',
  keywords: 'emergency exit security doors: safety and protection, security doors spain, costa del sol security',
};

export default function EmergencyExitSecurityDoorsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Emergency Exit Security Doors: Safety and Protection
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about emergency exit security doors: safety and protection.
            </p>
