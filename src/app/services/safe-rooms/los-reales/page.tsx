...
export const metadata: Metadata = {
  title: 'Safe Room Installation Los Reales | Cenit Security',
  description: 'Professional safe room installation installation in Los Reales, Estepona. Bespoke security solutions for luxury properties.',
  keywords: 'safe room installation los reales, security doors los reales, estepona security',
};

export default function SafeRoomsLosRealesPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Safe Room Installation Solutions for Los Reales
          </h2>
