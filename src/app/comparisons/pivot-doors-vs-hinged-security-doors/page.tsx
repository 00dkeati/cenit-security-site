...
export const metadata: Metadata = {
  title: 'Pivot Doors vs Hinged Security Doors | Cenit Security',
  description: 'Detailed comparison: pivot doors vs hinged security doors. Expert analysis to help Costa del Sol property owners choose.',
  keywords: 'pivot doors vs hinged security doors, security comparison, costa del sol',
};

export default function PivotDoorsVsHingedSecurityDoorsPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-8">
          Pivot Doors vs Hinged Security Doors
        </h1>
