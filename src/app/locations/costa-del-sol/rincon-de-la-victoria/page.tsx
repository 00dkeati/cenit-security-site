...
export const metadata: Metadata = {
  title: 'Security Doors Rincón de la Victoria | Cenit Security',
  description: 'Professional security door installation in Rincón de la Victoria, Costa del Sol. Bespoke solutions for luxury properties. Free consultation.',
  keywords: 'security doors rincón de la victoria, rincón de la victoria security, costa del sol security doors',
};

export default function RinconDeLaVictoriaPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-4">
          Security Doors Rincón de la Victoria
        </h1>
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            ...
            Rincón de la Victoria. Our bespoke solutions protect luxury villas and apartments 
            in this prestigious Costa del Sol location.
          </p>
          
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Security Solutions for Rincón de la Victoria
          </h2>
          <p className="text-gray-300 mb-4">
            Rincón de la Victoria features some of the most desirable properties in Costa del Sol, 
          ...
          <p className="text-gray-300 mb-4">
            ...
            common in Rincón de la Victoria, from contemporary villas to traditional estates. 
            We balance robust protection with aesthetic elegance.
          </p>
          
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Our Services in Rincón de la Victoria
          </h2>
          ...
          <p className="text-gray-300 mb-4">
            ...
            understand the specific security requirements of Rincón de la Victoria properties. 
          ...
          <div className="mt-12 p-8 bg-[#1a1a1a] rounded-lg border border-[#c9a961]/20">
            <h3 className="text-2xl font-serif text-[#c9a961] mb-4">
              Free Consultation in Rincón de la Victoria
            </h3>
            <p className="text-gray-300 mb-6">
              Contact us for a free security assessment of your Rincón de la Victoria property. 
