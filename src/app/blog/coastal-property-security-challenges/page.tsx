...
export const metadata: Metadata = {
  title: 'Coastal Property Security: Unique Challenges | Cenit Security Doors',
  description: 'Expert guide: coastal property security: unique challenges. Professional security door advice from Costa del Sol specialists.',
  keywords: 'coastal property security: unique challenges, security doors spain, costa del sol security',
};

export default function CoastalPropertySecurityChallengesPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Coastal Property Security: Unique Challenges
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about coastal property security: unique challenges.
            </p>
