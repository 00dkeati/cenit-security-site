...
export const metadata: Metadata = {
  title: 'Intruder Deterrent Features That Actually Work | Cenit Security Doors',
  description: 'Expert guide: intruder deterrent features that actually work. Professional security door advice from Costa del Sol specialists.',
  keywords: 'intruder deterrent features that actually work, security doors spain, costa del sol security',
};

export default function IntruderDeterrentFeaturesPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Intruder Deterrent Features That Actually Work
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about intruder deterrent features that actually work.
            </p>
