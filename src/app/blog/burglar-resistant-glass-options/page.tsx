...
export const metadata: Metadata = {
  title: 'Burglar-Resistant Glass Options for Doors | Cenit Security Doors',
  description: 'Expert guide: burglar-resistant glass options for doors. Professional security door advice from Costa del Sol specialists.',
  keywords: 'burglar-resistant glass options for doors, security doors spain, costa del sol security',
};

export default function BurglarResistantGlassOptionsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Burglar-Resistant Glass Options for Doors
          </h1>
