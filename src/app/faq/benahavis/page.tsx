...
export const metadata: Metadata = {
  title: 'Security Doors FAQ Benahavís | Cenit Security',
  description: 'Frequently asked questions about security doors in Benahavís, Costa del Sol. Expert answers from Cenit Security.',
  keywords: 'security doors faq, benahavís security, questions security doors',
};

export default function FAQBenahavisPage() {
  const faqs = [
    {
    ...
    },
    {
        ...
        "a": "Yes, we serve all areas of the Costa del Sol including Benahavís and surrounding regions. Our team handles installations from Sotogrande to Málaga."
    },
    {
  ...
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        <div className="mb-8">
          <Link href="/locations/benahavis" className="text-[#c9a961] hover:underline">
            ← Back to Benahavís
          </Link>
        </div>
        ...
        <h2 className="text-2xl text-gray-400 mb-12">Benahavís, Costa del Sol</h2>
