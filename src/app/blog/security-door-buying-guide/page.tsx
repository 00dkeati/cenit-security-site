...
export const metadata: Metadata = {
  title: 'Security Door Buying Guide: Everything to Consider | Cenit Security Doors',
  description: 'Expert guide: security door buying guide: everything to consider. Professional security door advice from Costa del Sol specialists.',
  keywords: 'security door buying guide: everything to consider, security doors spain, costa del sol security',
};

export default function SecurityDoorBuyingGuidePage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Security Door Buying Guide: Everything to Consider
          </h1>
