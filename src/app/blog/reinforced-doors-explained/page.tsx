...
export const metadata: Metadata = {
  title: 'Reinforced Doors Explained: Materials, Ratings & Benefits | Cenit Security Doors',
  description: 'Expert guide: reinforced doors explained: materials, ratings & benefits. Professional security door advice from Costa del Sol specialists.',
  keywords: 'reinforced doors explained: materials, ratings & benefits, security doors spain, costa del sol security',
};

export default function ReinforcedDoorsExplainedPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Reinforced Doors Explained: Materials, Ratings & Benefits
          </h1>
