...
export const metadata: Metadata = {
  title: 'Expatriate Property Security in Spain | Cenit Security Doors',
  description: 'Expatriate Property Security in Spain - comprehensive security guidance for Costa del Sol property owners from Cenit Security.',
  keywords: 'expatriate property security in spain, property security, costa del sol, spain',
};

export default function ExpatriatePropertySecuritySpainPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-8">
          Expatriate Property Security in Spain
        </h1>
