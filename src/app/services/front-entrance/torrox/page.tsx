...
export const metadata: Metadata = {
  title: 'Front Entrance Doors Torrox | Cenit Security',
  description: 'Professional front entrance doors installation in Torrox, Costa del Sol. Bespoke security solutions for luxury properties.',
  keywords: 'front entrance doors torrox, security doors torrox, costa del sol security',
};

export default function FrontEntranceTorroxPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Front Entrance Doors Solutions for Torrox
          </h2>
