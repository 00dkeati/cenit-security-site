...
export const metadata: Metadata = {
  title: 'Security Doors Near Me - Mijas Area | Cenit Security',
  description: 'Security Doors Near Me - Mijas Area. Professional security door installation and service. Free consultation available.',
  keywords: 'security doors near me - mijas area, security doors mijas, local security installer',
};

export default function SecurityDoorsNearMeMijasPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <p className="text-gray-300 mb-4">
            As a Mijas-based security company, we understand the specific needs 
          ...
          <p className="text-gray-300 mb-4">
            We've installed security doors throughout Mijas for villas, 
