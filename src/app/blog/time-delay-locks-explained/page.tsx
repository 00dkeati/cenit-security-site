...
export const metadata: Metadata = {
  title: 'Time Delay Locks: What They Are and Why Use Them | Cenit Security Doors',
  description: 'Expert guide: time delay locks: what they are and why use them. Professional security door advice from Costa del Sol specialists.',
  keywords: 'time delay locks: what they are and why use them, security doors spain, costa del sol security',
};

export default function TimeDelayLocksExplainedPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Time Delay Locks: What They Are and Why Use Them
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about time delay locks: what they are and why use them.
            </p>
