...
export const metadata: Metadata = {
  title: 'Security Door Trends 2026: What Is New | Cenit Security Doors',
  description: 'Expert guide: security door trends 2026: what is new. Professional security door advice from Costa del Sol specialists.',
  keywords: 'security door trends 2026: what is new, security doors spain, costa del sol security',
};

export default function SecurityDoorTrends2026Page() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Security Door Trends 2026: What Is New
          </h1>
          
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              The security industry continues to evolve with new technologies and approaches. Stay informed about the latest developments that could benefit your property.
            </p>
