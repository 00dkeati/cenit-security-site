...
export const metadata: Metadata = {
  title: 'Biometric Access Systems Cascada de Camojón | Cenit Security',
  description: 'Professional biometric access systems installation in Cascada de Camojón, Marbella. Bespoke security solutions for luxury properties.',
  keywords: 'biometric access systems cascada de camojón, security doors cascada de camojón, marbella security',
};

export default function BiometricAccessCamojanPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Biometric Access Systems Solutions for Cascada de Camojón
          </h2>
