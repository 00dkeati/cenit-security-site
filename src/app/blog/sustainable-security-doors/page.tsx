...
export const metadata: Metadata = {
  title: 'Sustainable Security Doors: Eco-Friendly Options | Cenit Security Doors',
  description: 'Expert guide: sustainable security doors: eco-friendly options. Professional security door advice from Costa del Sol specialists.',
  keywords: 'sustainable security doors: eco-friendly options, security doors spain, costa del sol security',
};

export default function SustainableSecurityDoorsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Sustainable Security Doors: Eco-Friendly Options
          </h1>
