...
export const metadata: Metadata = {
  title: 'Hidden Security Features for Discreet Protection | Cenit Security Doors',
  description: 'Expert guide: hidden security features for discreet protection. Professional security door advice from Costa del Sol specialists.',
  keywords: 'hidden security features for discreet protection, security doors spain, costa del sol security',
};

export default function HiddenSecurityFeaturesPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Hidden Security Features for Discreet Protection
          </h1>
