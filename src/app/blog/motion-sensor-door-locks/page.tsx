...
export const metadata: Metadata = {
  title: 'Motion Sensor Door Lock Systems | Cenit Security Doors',
  description: 'Expert guide: motion sensor door lock systems. Professional security door advice from Costa del Sol specialists.',
  keywords: 'motion sensor door lock systems, security doors spain, costa del sol security',
};

export default function MotionSensorDoorLocksPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Motion Sensor Door Lock Systems
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about motion sensor door lock systems.
            </p>
