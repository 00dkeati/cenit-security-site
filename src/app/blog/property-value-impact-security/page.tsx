...
export const metadata: Metadata = {
  title: 'How Security Upgrades Impact Property Value in Spain | Cenit Security Doors',
  description: 'Expert guide: how security upgrades impact property value in spain. Professional security door advice from Costa del Sol specialists.',
  keywords: 'how security upgrades impact property value in spain, security doors spain, costa del sol security',
};

export default function PropertyValueImpactSecurityPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            How Security Upgrades Impact Property Value in Spain
          </h1>
          
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Data-driven insights help property owners understand the security landscape on the Costa del Sol. This research-based article examines trends, statistics, and expert recommendations.
            </p>
