...
export const metadata: Metadata = {
  title: 'Retrofitting Security Doors to Existing Properties | Cenit Security Doors',
  description: 'Expert guide: retrofitting security doors to existing properties. Professional security door advice from Costa del Sol specialists.',
  keywords: 'retrofitting security doors to existing properties, security doors spain, costa del sol security',
};

export default function RetrofittingSecurityDoorsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Retrofitting Security Doors to Existing Properties
          </h1>
