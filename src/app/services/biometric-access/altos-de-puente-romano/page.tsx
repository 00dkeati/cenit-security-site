...
export const metadata: Metadata = {
  title: 'Biometric Access Systems Altos de Puente Romano | Cenit Security',
  description: 'Professional biometric access systems installation in Altos de Puente Romano, Marbella. Bespoke security solutions for luxury properties.',
  keywords: 'biometric access systems altos de puente romano, security doors altos de puente romano, marbella security',
};

export default function BiometricAccessAltosDePuenteRomanoPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Biometric Access Systems Solutions for Altos de Puente Romano
          </h2>
