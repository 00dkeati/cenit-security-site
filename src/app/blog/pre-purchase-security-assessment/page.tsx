...
export const metadata: Metadata = {
  title: 'Pre-Purchase Property Security Assessment | Cenit Security Doors',
  description: 'Expert guide: pre-purchase property security assessment. Professional security door advice from Costa del Sol specialists.',
  keywords: 'pre-purchase property security assessment, security doors spain, costa del sol security',
};

export default function PrePurchaseSecurityAssessmentPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Pre-Purchase Property Security Assessment
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about pre-purchase property security assessment.
            </p>
