...
export const metadata: Metadata = {
  title: 'Fire-Rated Security Doors: What You Need to Know | Cenit Security Doors',
  description: 'Expert guide: fire-rated security doors: what you need to know. Professional security door advice from Costa del Sol specialists.',
  keywords: 'fire-rated security doors: what you need to know, security doors spain, costa del sol security',
};

export default function FireRatedSecurityDoorsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Fire-Rated Security Doors: What You Need to Know
          </h1>
