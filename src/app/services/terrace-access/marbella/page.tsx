...
export const metadata = {
  title: "Terrace & Secondary Access in Marbella | Cenit Security Doors",
  description: "Terrace & Secondary Access for luxury properties in Marbella. London-standard security engineering with bespoke design and discreet installation.",
};

export default function TerraceAccessMarbellaPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-[#f5f0e8]">
      ...
      <section className="relative h-[60vh] flex items-end">
        <div className="absolute inset-0">
          <Image src="/doors/door-02.jpg" alt="Terrace Access in Marbella" fill className="object-cover" priority />
        ...
        <div className="relative z-10 w-full pb-16 px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-light">Terrace Access in Marbella</h1>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-3 gap-16">
          <div className="lg:col-span-2 space-y-8">
            ...
            <p className="text-2xl font-light leading-relaxed text-[#f5f0e8]/90">
              Specialist terrace & secondary access for luxury properties throughout Marbella.
            </p>
            <div className="text-lg text-[#f5f0e8]/70 leading-relaxed space-y-6">
              <p>
                Cenit Security Doors provides bespoke terrace & secondary access across Marbella, from initial consultation through to installation and commissioning. Our solutions are engineered to the highest standards whilst complementing the architectural character of your property.
              </p>
              <p>
                Marbella properties demand security solutions that match their prestige. We work with homeowners, architects, and developers to deliver terrace & secondary access that provide certified protection without compromising on aesthetics.
              </p>
              <p>
          ...
          <div className="space-y-6">
            ...
            <a 
              href="https://wa.me/34667793100?text=Hello%2C%20I%27m%20interested%20in%20terrace%20%26%20secondary%20access%20for%20my%20property%20in%20Marbella"
              target="_blank"
