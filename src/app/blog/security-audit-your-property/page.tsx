...
export const metadata: Metadata = {
  title: 'How to Security Audit Your Property | Cenit Security Doors',
  description: 'Expert guide: how to security audit your property. Professional security door advice from Costa del Sol specialists.',
  keywords: 'how to security audit your property, security doors spain, costa del sol security',
};

export default function SecurityAuditYourPropertyPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            How to Security Audit Your Property
          </h1>
