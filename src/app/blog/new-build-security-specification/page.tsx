...
export const metadata: Metadata = {
  title: 'Security Specification for New Build Projects | Cenit Security Doors',
  description: 'Expert guide: security specification for new build projects. Professional security door advice from Costa del Sol specialists.',
  keywords: 'security specification for new build projects, security doors spain, costa del sol security',
};

export default function NewBuildSecuritySpecificationPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Security Specification for New Build Projects
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about security specification for new build projects.
            </p>
