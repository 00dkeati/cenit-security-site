...
export const metadata: Metadata = {
  title: 'Terrace Access Doors Cortijo Blanco | Cenit Security',
  description: 'Professional terrace access doors installation in Cortijo Blanco, San Pedro de Alcántara. Bespoke security solutions for luxury properties.',
  keywords: 'terrace access doors cortijo blanco, security doors cortijo blanco, san pedro de alcántara security',
};

export default function TerraceAccessCortijoBlancoPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Terrace Access Doors Solutions for Cortijo Blanco
          </h2>
