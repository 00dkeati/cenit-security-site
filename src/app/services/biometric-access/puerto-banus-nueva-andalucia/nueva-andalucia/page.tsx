...
export const metadata = {
  title: "Biometric Access in Nueva Andalucía, Nueva Andalucía | Cenit Security Doors",
  description: "Biometric Access Control for luxury properties in Nueva Andalucía. London-standard security engineering with bespoke design and discreet installation across Nueva Andalucía.",
  keywords: "biometric access control, Nueva Andalucía, Nueva Andalucía, security doors, Costa del Sol, luxury security",
};
    ...
    <main className="min-h-screen bg-[#0f0f0f] text-[#f5f0e8]">
      ...
      <section className="relative h-[60vh] flex items-end">
        <div className="absolute inset-0">
          <Image src="/doors/door-08.jpg" alt="Biometric Access in Nueva Andalucía" fill className="object-cover" priority />
        ...
        <div className="relative z-10 w-full pb-16 px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-light">Biometric Access in Nueva Andalucía</h1>
          ...
          <div className="grid lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2 space-y-8">
              ...
              <h2 className="text-3xl font-light leading-relaxed text-[#f5f0e8]/90">
                Expert Biometric Access Control for Nueva Andalucía Properties
              </h2>
              <div className="text-lg text-[#f5f0e8]/70 leading-relaxed space-y-6">
                <p>Nueva Andalucía properties with household staff, frequent guests, or multiple family members benefit from biometric access control. Eliminate keys and codes with fingerprint and facial recognition systems that provide convenience alongside an irrefutable audit trail.</p>
                <p>
            ...
            <div className="space-y-6">
              ...
              <a 
                href="https://wa.me/34667793100?text=Hello%2C%20I%27m%20interested%20in%20biometric%20access%20control%20for%20my%20property%20in%20Nueva%20Andaluc%C3%ADa%2C%20Nueva%20Andaluc%C3%ADa"
                target="_blank"
