...
export const metadata: Metadata = {
  title: 'Security Door Materials: Steel vs Aluminium vs Composite | Cenit Security Doors',
  description: 'Expert guide: security door materials: steel vs aluminium vs composite. Professional security door advice from Costa del Sol specialists.',
  keywords: 'security door materials: steel vs aluminium vs composite, security doors spain, costa del sol security',
};

export default function SecurityDoorMaterialsComparisonPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Security Door Materials: Steel vs Aluminium vs Composite
          </h1>
          
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Choosing the right security solution requires understanding your options. In this detailed comparison, we examine the key differences, advantages, and considerations to help Costa del Sol property owners make an informed decision.
            </p>
