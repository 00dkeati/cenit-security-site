...
export const metadata = {
  title: "Security Doors for Townhouses in Puerto Banús | Cenit Security Doors",
  description: "Security solutions for exclusive townhouse communities in Puerto Banús. London-standard security engineering for Costa del Sol properties.",
};
    ...
    <main className="min-h-screen bg-[#0f0f0f] text-[#f5f0e8]">
      ...
      <section className="relative h-[60vh] flex items-end">
        <div className="absolute inset-0">
          <Image src="/doors/door-05.jpg" alt="Townhouses security in Puerto Banús" fill className="object-cover" priority />
        ...
        <div className="relative z-10 w-full pb-16 px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-light">Security Doors for Townhouses</h1>
      ...
      <section className="py-20 px-8">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <p className="text-2xl font-light leading-relaxed text-[#f5f0e8]/90">
            Security solutions for exclusive townhouse communities across Puerto Banús.
          </p>
          <div className="text-lg text-[#f5f0e8]/70 leading-relaxed space-y-6">
            <p>
              townhouses in Puerto Banús present unique security challenges and opportunities. Cenit Security Doors specialises in engineering bespoke solutions that address the specific requirements of townhouses.
            </p>
            <p>
            ...
            <p>
              Contact us to discuss your townhouses security requirements in Puerto Banús.
            </p>
          </div>
          <a 
            href="https://wa.me/34667793100?text=Hello%2C%20I%27m%20interested%20in%20security%20doors%20for%20my%20townhouses%20in%20Puerto%20Ban%C3%BAs"
            target="_blank"
