...
export const metadata = {
  title: "Safe Rooms in Elviria, Marbella | Cenit Security Doors",
  description: "Safe Rooms & Panic Rooms for luxury properties in Elviria. London-standard security engineering with bespoke design and discreet installation across Marbella.",
  keywords: "safe rooms & panic rooms, Elviria, Marbella, security doors, Costa del Sol, luxury security",
};
    ...
    <main className="min-h-screen bg-[#0f0f0f] text-[#f5f0e8]">
      ...
      <section className="relative h-[60vh] flex items-end">
        <div className="absolute inset-0">
          <Image src="/doors/door-01.jpg" alt="Safe Rooms in Elviria" fill className="object-cover" priority />
        ...
        <div className="relative z-10 w-full pb-16 px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-light">Safe Rooms in Elviria</h1>
          ...
          <div className="grid lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2 space-y-8">
              ...
              <h2 className="text-3xl font-light leading-relaxed text-[#f5f0e8]/90">
                Expert Safe Rooms & Panic Rooms for Elviria Properties
              </h2>
              <div className="text-lg text-[#f5f0e8]/70 leading-relaxed space-y-6">
                <p>For Elviria's most discerning residents, a safe room provides the ultimate layer of protection. Whether safeguarding family members during emergencies or protecting high-value assets around the clock, our safe room installations deliver certified security with complete discretion.</p>
                <p>
            ...
            <div className="space-y-6">
              ...
              <a 
                href="https://wa.me/34667793100?text=Hello%2C%20I%27m%20interested%20in%20safe%20rooms%20%26%20panic%20rooms%20for%20my%20property%20in%20Elviria%2C%20Marbella"
                target="_blank"
