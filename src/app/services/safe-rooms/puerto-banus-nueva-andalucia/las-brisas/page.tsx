...
export const metadata = {
  title: "Safe Rooms Las Brisas | Cenit Security Doors",
  description: "Safe Rooms & Panic Rooms for properties in Las Brisas, Nueva Andalucía. Bespoke security engineering with discreet installation.",
};
    ...
    <main className="min-h-screen bg-[#0f0f0f] text-[#f5f0e8]">
      ...
      <section className="relative h-[60vh] flex items-end">
        <div className="absolute inset-0">
          <Image src="/doors/door-08.jpg" alt="Safe Rooms Las Brisas" fill className="object-cover" priority />
      ...
      <section className="py-20 px-8">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <p className="text-2xl font-light leading-relaxed text-[#f5f0e8]/90">
            Specialist safe rooms & panic rooms for Las Brisas properties.
          </p>
          <div className="text-lg text-[#f5f0e8]/70 leading-relaxed space-y-6">
            <p>
              Las Brisas is one of the most prestigious addresses in Nueva Andalucía. Properties here demand safe rooms & panic rooms that match their exceptional standards.
            </p>
            <p>
              Cenit Security Doors provides bespoke safe rooms & panic rooms throughout Las Brisas, working with homeowners and architects to deliver solutions that integrate seamlessly with each property&apos;s unique character.
            </p>
            <p>
          ...
          <a 
            href="https://wa.me/34667793100?text=Hello%2C%20I%27m%20interested%20in%20safe%20rooms%20%26%20panic%20rooms%20for%20my%20property%20in%20Las%20Brisas"
            target="_blank"
