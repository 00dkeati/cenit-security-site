...
export const metadata: Metadata = {
  title: 'Custom Security Door Designs: Style Meets Protection | Cenit Security Doors',
  description: 'Expert guide: custom security door designs: style meets protection. Professional security door advice from Costa del Sol specialists.',
  keywords: 'custom security door designs: style meets protection, security doors spain, costa del sol security',
};

export default function CustomSecurityDoorDesignsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Custom Security Door Designs: Style Meets Protection
          </h1>
