...
export const metadata: Metadata = {
  title: 'Rural Finca Security Guide | Cenit Security Doors',
  description: 'Rural Finca Security Guide - comprehensive security guidance for Costa del Sol property owners from Cenit Security.',
  keywords: 'rural finca security guide, property security, costa del sol, spain',
};

export default function RuralFincaSecurityGuidePage() {
  return (
