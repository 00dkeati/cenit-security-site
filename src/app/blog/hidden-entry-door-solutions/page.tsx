...
export const metadata: Metadata = {
  title: 'Hidden Entry Door Solutions for Seamless Design | Cenit Security Doors',
  description: 'Expert guide: hidden entry door solutions for seamless design. Professional security door advice from Costa del Sol specialists.',
  keywords: 'hidden entry door solutions for seamless design, security doors spain, costa del sol security',
};

export default function HiddenEntryDoorSolutionsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Hidden Entry Door Solutions for Seamless Design
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about hidden entry door solutions for seamless design.
            </p>
