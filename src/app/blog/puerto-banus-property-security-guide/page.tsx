...
export const metadata: Metadata = {
  title: 'Puerto Banús Property Security Guide | Cenit Security Doors',
  description: 'Expert guide: puerto banús property security guide. Professional security door advice from Costa del Sol specialists.',
  keywords: 'puerto banús property security guide, security doors spain, costa del sol security',
};

export default function PuertoBanusPropertySecurityGuidePage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Puerto Banús Property Security Guide
          </h1>
