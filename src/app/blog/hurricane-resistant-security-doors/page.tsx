...
export const metadata: Metadata = {
  title: 'Hurricane Resistant Security Doors | Cenit Security Doors',
  description: 'Expert guide: hurricane resistant security doors. Professional security door advice from Costa del Sol specialists.',
  keywords: 'hurricane resistant security doors, security doors spain, costa del sol security',
};

export default function HurricaneResistantSecurityDoorsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Hurricane Resistant Security Doors
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about hurricane resistant security doors.
            </p>
