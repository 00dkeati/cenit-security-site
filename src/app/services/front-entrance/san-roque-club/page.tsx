...
export const metadata: Metadata = {
  title: 'Front Entrance Doors San Roque Club | Cenit Security',
  description: 'Professional front entrance doors installation in San Roque Club, Sotogrande. Bespoke security solutions for luxury properties.',
  keywords: 'front entrance doors san roque club, security doors san roque club, sotogrande security',
};

export default function FrontEntranceSanRoqueClubPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Front Entrance Doors Solutions for San Roque Club
          </h2>
