...
export const metadata = {
  title: "Security Doors for Luxury Villas in Marbella | Cenit Security Doors",
  description: "Bespoke security solutions for detached villas in Marbella. London-standard security engineering for Costa del Sol properties.",
};
    ...
    <main className="min-h-screen bg-[#0f0f0f] text-[#f5f0e8]">
      ...
      <section className="relative h-[60vh] flex items-end">
        <div className="absolute inset-0">
          <Image src="/doors/door-02.jpg" alt="Luxury Villas security in Marbella" fill className="object-cover" priority />
      ...
      <section className="py-20 px-8">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <p className="text-2xl font-light leading-relaxed text-[#f5f0e8]/90">
            Bespoke security solutions for detached villas across Marbella.
          </p>
          <div className="text-lg text-[#f5f0e8]/70 leading-relaxed space-y-6">
            <p>
              luxury villas in Marbella present unique security challenges and opportunities. Cenit Security Doors specialises in engineering bespoke solutions that address the specific requirements of luxury villas.
            </p>
            <p>
            ...
            <p>
              Contact us to discuss your villas security requirements in Marbella.
            </p>
          </div>
          <a 
            href="https://wa.me/34667793100?text=Hello%2C%20I%27m%20interested%20in%20security%20doors%20for%20my%20luxury%20villas%20in%20Marbella"
            target="_blank"
