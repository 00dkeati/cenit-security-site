...
export const metadata: Metadata = {
  title: 'Affordable Security Doors Marbella | Cenit Security',
  description: 'Affordable Security Doors Marbella. Professional security door installation and service. Free consultation available.',
  keywords: 'affordable security doors marbella, security doors marbella, local security installer',
};

export default function AffordableSecurityDoorsMarbellaPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-4">
          Affordable Security Doors Marbella
        </h1>
