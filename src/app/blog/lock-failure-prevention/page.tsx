...
export const metadata: Metadata = {
  title: 'Preventing Lock Failure: Maintenance Tips | Cenit Security Doors',
  description: 'Expert guide: preventing lock failure: maintenance tips. Professional security door advice from Costa del Sol specialists.',
  keywords: 'preventing lock failure: maintenance tips, security doors spain, costa del sol security',
};

export default function LockFailurePreventionPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Preventing Lock Failure: Maintenance Tips
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about preventing lock failure: maintenance tips.
            </p>
