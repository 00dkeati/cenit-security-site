...
export const metadata: Metadata = {
  title: 'Spanish vs German Security Doors | Cenit Security',
  description: 'Detailed comparison: spanish vs german security doors. Expert analysis to help Costa del Sol property owners choose.',
  keywords: 'spanish vs german security doors, security comparison, costa del sol',
};

export default function SpanishVsGermanSecurityDoorsPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-8">
          Spanish vs German Security Doors
        </h1>
