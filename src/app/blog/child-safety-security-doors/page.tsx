...
export const metadata: Metadata = {
  title: 'Child Safety Features in Modern Security Doors | Cenit Security Doors',
  description: 'Expert guide: child safety features in modern security doors. Professional security door advice from Costa del Sol specialists.',
  keywords: 'child safety features in modern security doors, security doors spain, costa del sol security',
};

export default function ChildSafetySecurityDoorsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Child Safety Features in Modern Security Doors
          </h1>
