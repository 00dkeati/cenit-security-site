...
export const metadata: Metadata = {
  title: 'Front Entrance Doors El Padrón | Cenit Security',
  description: 'Professional front entrance doors installation in El Padrón, Estepona. Bespoke security solutions for luxury properties.',
  keywords: 'front entrance doors el padrón, security doors el padrón, estepona security',
};

export default function FrontEntranceElPadronPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Front Entrance Doors Solutions for El Padrón
          </h2>
