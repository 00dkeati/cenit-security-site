...
export const metadata: Metadata = {
  title: 'Spanish Property Security Laws You Should Know | Cenit Security Doors',
  description: 'Expert guide: spanish property security laws you should know. Professional security door advice from Costa del Sol specialists.',
  keywords: 'spanish property security laws you should know, security doors spain, costa del sol security',
};

export default function SpanishPropertySecurityLawsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Spanish Property Security Laws You Should Know
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about spanish property security laws you should know.
            </p>
