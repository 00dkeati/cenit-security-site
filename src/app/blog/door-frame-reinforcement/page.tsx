...
export const metadata: Metadata = {
  title: 'Door Frame Reinforcement: The Overlooked Essential | Cenit Security Doors',
  description: 'Expert guide: door frame reinforcement: the overlooked essential. Professional security door advice from Costa del Sol specialists.',
  keywords: 'door frame reinforcement: the overlooked essential, security doors spain, costa del sol security',
};

export default function DoorFrameReinforcementPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Door Frame Reinforcement: The Overlooked Essential
          </h1>
