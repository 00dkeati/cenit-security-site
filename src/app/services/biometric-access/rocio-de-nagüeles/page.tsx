...
export const metadata: Metadata = {
  title: 'Biometric Access Systems Rocío de Nagüeles | Cenit Security',
  description: 'Professional biometric access systems installation in Rocío de Nagüeles, Marbella. Bespoke security solutions for luxury properties.',
  keywords: 'biometric access systems rocío de nagüeles, security doors rocío de nagüeles, marbella security',
};

export default function BiometricAccessRocioDeNagüelesPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Biometric Access Systems Solutions for Rocío de Nagüeles
          </h2>
