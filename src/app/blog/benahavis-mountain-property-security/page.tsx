...
export const metadata: Metadata = {
  title: 'Benahavís Mountain Property Security | Cenit Security Doors',
  description: 'Expert guide: benahavís mountain property security. Professional security door advice from Costa del Sol specialists.',
  keywords: 'benahavís mountain property security, security doors spain, costa del sol security',
};

export default function BenahavisMountainPropertySecurityPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Benahavís Mountain Property Security
          </h1>
