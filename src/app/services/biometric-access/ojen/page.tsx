...
export const metadata: Metadata = {
  title: 'Biometric Access Systems Ojén | Cenit Security',
  description: 'Professional biometric access systems installation in Ojén, Costa del Sol. Bespoke security solutions for luxury properties.',
  keywords: 'biometric access systems ojén, security doors ojén, costa del sol security',
};

export default function BiometricAccessOjenPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Biometric Access Systems Solutions for Ojén
          </h2>
