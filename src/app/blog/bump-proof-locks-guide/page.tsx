...
export const metadata: Metadata = {
  title: 'Bump-Proof Locks: Complete Guide | Cenit Security Doors',
  description: 'Expert guide: bump-proof locks: complete guide. Professional security door advice from Costa del Sol specialists.',
  keywords: 'bump-proof locks: complete guide, security doors spain, costa del sol security',
};

export default function BumpProofLocksGuidePage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Bump-Proof Locks: Complete Guide
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about bump-proof locks: complete guide.
            </p>
