...
export const metadata: Metadata = {
  title: 'CCTV Integration with Security Door Systems | Cenit Security Doors',
  description: 'Expert guide: cctv integration with security door systems. Professional security door advice from Costa del Sol specialists.',
  keywords: 'cctv integration with security door systems, security doors spain, costa del sol security',
};

export default function CctvIntegrationWithDoorsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            CCTV Integration with Security Door Systems
          </h1>
