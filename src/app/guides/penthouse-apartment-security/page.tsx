...
export const metadata: Metadata = {
  title: 'Penthouse & Apartment Security Guide | Cenit Security Doors',
  description: 'Penthouse & Apartment Security Guide - comprehensive security guidance for Costa del Sol property owners from Cenit Security.',
  keywords: 'penthouse & apartment security guide, property security, costa del sol, spain',
};

export default function PenthouseApartmentSecurityPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-8">
          Penthouse & Apartment Security Guide
        </h1>
