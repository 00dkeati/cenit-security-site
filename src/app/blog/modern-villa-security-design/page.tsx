...
export const metadata: Metadata = {
  title: 'Modern Villa Security: Design Meets Protection | Cenit Security Doors',
  description: 'Expert guide: modern villa security: design meets protection. Professional security door advice from Costa del Sol specialists.',
  keywords: 'modern villa security: design meets protection, security doors spain, costa del sol security',
};

export default function ModernVillaSecurityDesignPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Modern Villa Security: Design Meets Protection
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about modern villa security: design meets protection.
            </p>
