...
export const metadata: Metadata = {
  title: 'Upgrading Security During Renovation | Cenit Security Doors',
  description: 'Expert guide: upgrading security during renovation. Professional security door advice from Costa del Sol specialists.',
  keywords: 'upgrading security during renovation, security doors spain, costa del sol security',
};

export default function RenovationSecurityUpgradePage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Upgrading Security During Renovation
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about upgrading security during renovation.
            </p>
