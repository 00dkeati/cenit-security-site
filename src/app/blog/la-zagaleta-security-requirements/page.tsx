...
export const metadata: Metadata = {
  title: 'La Zagaleta Security Requirements for Homeowners | Cenit Security Doors',
  description: 'Expert guide: la zagaleta security requirements for homeowners. Professional security door advice from Costa del Sol specialists.',
  keywords: 'la zagaleta security requirements for homeowners, security doors spain, costa del sol security',
};

export default function LaZagaletaSecurityRequirementsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            La Zagaleta Security Requirements for Homeowners
          </h1>
