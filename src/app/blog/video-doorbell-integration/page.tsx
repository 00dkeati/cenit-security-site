...
export const metadata: Metadata = {
  title: 'Video Doorbell Integration with Security Doors | Cenit Security Doors',
  description: 'Expert guide: video doorbell integration with security doors. Professional security door advice from Costa del Sol specialists.',
  keywords: 'video doorbell integration with security doors, security doors spain, costa del sol security',
};

export default function VideoDoorbellIntegrationPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Video Doorbell Integration with Security Doors
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about video doorbell integration with security doors.
            </p>
