...
export const metadata: Metadata = {
  title: 'Security Doors Bel Air | Cenit Security',
  description: 'Professional security door installation in Bel Air, Estepona. Bespoke solutions for luxury properties. Free consultation.',
  keywords: 'security doors bel air, bel air security, estepona security doors',
};
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            ...
            Bel Air. Our bespoke solutions protect luxury villas and apartments 
            in this prestigious Estepona location.
          </p>
          
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Security Solutions for Bel Air
          </h2>
          <p className="text-gray-300 mb-4">
            Bel Air features some of the most desirable properties in Estepona, 
          ...
          <p className="text-gray-300 mb-4">
            ...
            common in Bel Air, from contemporary villas to traditional estates. 
          ...
          <p className="text-gray-300 mb-4">
            ...
            understand the specific security requirements of Bel Air properties. 
          ...
          <div className="mt-12 p-8 bg-[#1a1a1a] rounded-lg border border-[#c9a961]/20">
            <h3 className="text-2xl font-serif text-[#c9a961] mb-4">
              Free Consultation in Bel Air
            </h3>
            <p className="text-gray-300 mb-6">
              Contact us for a free security assessment of your Bel Air property. 
