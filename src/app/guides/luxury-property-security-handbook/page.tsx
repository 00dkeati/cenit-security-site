...
export const metadata: Metadata = {
  title: 'Luxury Property Security Handbook | Cenit Security Doors',
  description: 'Luxury Property Security Handbook - comprehensive security guidance for Costa del Sol property owners from Cenit Security.',
  keywords: 'luxury property security handbook, property security, costa del sol, spain',
};

export default function LuxuryPropertySecurityHandbookPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-8">
          Luxury Property Security Handbook
        </h1>
