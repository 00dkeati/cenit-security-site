...
export const metadata: Metadata = {
  title: 'European Security Door Standards & Certifications | Cenit Security Doors',
  description: 'Expert guide: european security door standards & certifications. Professional security door advice from Costa del Sol specialists.',
  keywords: 'european security door standards & certifications, security doors spain, costa del sol security',
};

export default function EuropeanSecurityDoorStandardsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            European Security Door Standards & Certifications
          </h1>
