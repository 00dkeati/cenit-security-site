...
export const metadata: Metadata = {
  title: 'Residential vs Commercial Security Doors | Cenit Security',
  description: 'Detailed comparison: residential vs commercial security doors. Expert analysis to help Costa del Sol property owners choose.',
  keywords: 'residential vs commercial security doors, security comparison, costa del sol',
};

export default function ResidentialVsCommercialSecurityPage() {
  return (
