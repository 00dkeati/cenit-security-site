...
export const metadata: Metadata = {
  title: 'Security Doors FAQ Sotogrande | Cenit Security',
  description: 'Frequently asked questions about security doors in Sotogrande, Costa del Sol. Expert answers from Cenit Security.',
  keywords: 'security doors faq, sotogrande security, questions security doors',
};

export default function FAQSotograndePage() {
  const faqs = [
    {
    ...
    },
    {
        ...
        "a": "Yes, we serve all areas of the Costa del Sol including Sotogrande and surrounding regions. Our team handles installations from Sotogrande to Málaga."
    },
    {
  ...
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h2 className="text-2xl text-gray-400 mb-12">Sotogrande, Costa del Sol</h2>
