...
export const metadata: Metadata = {
  title: 'Security Doors Near Me - Sotogrande Area | Cenit Security',
  description: 'Security Doors Near Me - Sotogrande Area. Professional security door installation and service. Free consultation available.',
  keywords: 'security doors near me - sotogrande area, security doors sotogrande, local security installer',
};

export default function SecurityDoorsNearMeSotograndePage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-4">
          Security Doors Near Me - Sotogrande Area
        </h1>
        <p className="text-2xl text-gray-400 mb-8">Professional Security Door Installation</p>
        
        <div className="prose prose-invert prose-lg max-w-none">
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            Looking for security doors in Sotogrande? Cenit Security is your local 
            specialist for premium security door installation throughout the Costa del Sol. 
            We serve Sotogrande and surrounding areas with professional, reliable service.
          </p>
          ...
          <p className="text-gray-300 mb-4">
            As a Sotogrande-based security company, we understand the specific needs 
          ...
          <p className="text-gray-300 mb-4">
            We've installed security doors throughout Sotogrande for villas, 
          ...
          <div className="mt-12 p-8 bg-[#1a1a1a] rounded-lg border border-[#c9a961]/20">
            <h3 className="text-2xl font-serif text-[#c9a961] mb-4">
              Free Consultation in Sotogrande
            </h3>
