...
export const metadata: Metadata = {
  title: 'Biometric Access Systems El Padrón | Cenit Security',
  description: 'Professional biometric access systems installation in El Padrón, Estepona. Bespoke security solutions for luxury properties.',
  keywords: 'biometric access systems el padrón, security doors el padrón, estepona security',
};

export default function BiometricAccessElPadronPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Biometric Access Systems Solutions for El Padrón
          </h2>
