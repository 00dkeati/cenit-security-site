...
export const metadata: Metadata = {
  title: 'Multi-Point Locking Systems: How They Work | Cenit Security Doors',
  description: 'Expert guide: multi-point locking systems: how they work. Professional security door advice from Costa del Sol specialists.',
  keywords: 'multi-point locking systems: how they work, security doors spain, costa del sol security',
};

export default function MultiPointLockingSystemsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Multi-Point Locking Systems: How They Work
          </h1>
