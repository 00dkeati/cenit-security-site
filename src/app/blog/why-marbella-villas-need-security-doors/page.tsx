...
export const metadata: Metadata = {
  title: 'Why Marbella Villas Need Security Doors | Cenit Security Doors',
  description: 'Expert guide: why marbella villas need security doors. Professional security door advice from Costa del Sol specialists.',
  keywords: 'why marbella villas need security doors, security doors spain, costa del sol security',
};

export default function WhyMarbellaVillasNeedSecurityDoorsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Why Marbella Villas Need Security Doors
          </h1>
