...
export const metadata: Metadata = {
  title: 'Budget vs Premium Security Doors: Worth the Difference? | Cenit Security',
  description: 'Detailed comparison: budget vs premium security doors: worth the difference?. Expert analysis to help Costa del Sol property owners choose.',
  keywords: 'budget vs premium security doors: worth the difference?, security comparison, costa del sol',
};

export default function BudgetVsPremiumSecurityDoorsPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-8">
          Budget vs Premium Security Doors: Worth the Difference?
        </h1>
