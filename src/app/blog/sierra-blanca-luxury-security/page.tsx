...
export const metadata: Metadata = {
  title: 'Sierra Blanca Luxury Security Solutions | Cenit Security Doors',
  description: 'Expert guide: sierra blanca luxury security solutions. Professional security door advice from Costa del Sol specialists.',
  keywords: 'sierra blanca luxury security solutions, security doors spain, costa del sol security',
};

export default function SierraBlancaLuxurySecurityPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Sierra Blanca Luxury Security Solutions
          </h1>
