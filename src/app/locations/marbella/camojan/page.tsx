...
export const metadata: Metadata = {
  title: 'Security Doors Cascada de Camojón | Cenit Security',
  description: 'Professional security door installation in Cascada de Camojón, Marbella. Bespoke solutions for luxury properties. Free consultation.',
  keywords: 'security doors cascada de camojón, cascada de camojón security, marbella security doors',
};

export default function CamojanPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-4">
          Security Doors Cascada de Camojón
        </h1>
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            ...
            Cascada de Camojón. Our bespoke solutions protect luxury villas and apartments 
            in this prestigious Marbella location.
          </p>
          
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Security Solutions for Cascada de Camojón
          </h2>
          <p className="text-gray-300 mb-4">
            Cascada de Camojón features some of the most desirable properties in Marbella, 
          ...
          <p className="text-gray-300 mb-4">
            ...
            common in Cascada de Camojón, from contemporary villas to traditional estates. 
            We balance robust protection with aesthetic elegance.
          </p>
          
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Our Services in Cascada de Camojón
          </h2>
          ...
          <p className="text-gray-300 mb-4">
            ...
            understand the specific security requirements of Cascada de Camojón properties. 
          ...
          <div className="mt-12 p-8 bg-[#1a1a1a] rounded-lg border border-[#c9a961]/20">
            <h3 className="text-2xl font-serif text-[#c9a961] mb-4">
              Free Consultation in Cascada de Camojón
            </h3>
            <p className="text-gray-300 mb-6">
              Contact us for a free security assessment of your Cascada de Camojón property. 
