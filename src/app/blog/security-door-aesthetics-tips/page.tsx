...
export const metadata: Metadata = {
  title: 'Making Security Doors Look Elegant | Cenit Security Doors',
  description: 'Expert guide: making security doors look elegant. Professional security door advice from Costa del Sol specialists.',
  keywords: 'making security doors look elegant, security doors spain, costa del sol security',
};

export default function SecurityDoorAestheticsTipsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Making Security Doors Look Elegant
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about making security doors look elegant.
            </p>
