...
export const metadata: Metadata = {
  title: 'How Security Doors Are Installed: Step-by-Step Process | Cenit Security Doors',
  description: 'Expert guide: how security doors are installed: step-by-step process. Professional security door advice from Costa del Sol specialists.',
  keywords: 'how security doors are installed: step-by-step process, security doors spain, costa del sol security',
};

export default function HowSecurityDoorsAreInstalledPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            How Security Doors Are Installed: Step-by-Step Process
          </h1>
