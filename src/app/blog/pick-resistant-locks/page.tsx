...
export const metadata: Metadata = {
  title: 'Pick-Resistant Locks for Maximum Security | Cenit Security Doors',
  description: 'Expert guide: pick-resistant locks for maximum security. Professional security door advice from Costa del Sol specialists.',
  keywords: 'pick-resistant locks for maximum security, security doors spain, costa del sol security',
};

export default function PickResistantLocksPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Pick-Resistant Locks for Maximum Security
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about pick-resistant locks for maximum security.
            </p>
