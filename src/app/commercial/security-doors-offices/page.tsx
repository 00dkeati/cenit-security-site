...
export const metadata: Metadata = {
  title: 'Security Doors for Offices | Cenit Security Costa del Sol',
  description: 'Security Doors for Offices - specialist commercial security solutions for Costa del Sol businesses. Professional installation.',
  keywords: 'security doors for offices, commercial security doors, costa del sol business security',
};

export default function SecurityDoorsOfficesPage() {
  return (
