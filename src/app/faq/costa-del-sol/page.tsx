...
export const metadata: Metadata = {
  title: 'Security Doors FAQ Costa del Sol | Cenit Security',
  description: 'Frequently asked questions about security doors in Costa del Sol, Costa del Sol. Expert answers from Cenit Security.',
  keywords: 'security doors faq, costa del sol security, questions security doors',
};

export default function FAQCostaDelSolPage() {
  const faqs = [
    {
    ...
    },
    {
        ...
        "a": "Yes, we serve all areas of the Costa del Sol including Costa del Sol and surrounding regions. Our team handles installations from Sotogrande to Málaga."
    },
    {
  ...
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h2 className="text-2xl text-gray-400 mb-12">Costa del Sol, Costa del Sol</h2>
