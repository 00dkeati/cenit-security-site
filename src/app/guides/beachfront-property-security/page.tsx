...
export const metadata: Metadata = {
  title: 'Beachfront Property Security Considerations | Cenit Security Doors',
  description: 'Beachfront Property Security Considerations - comprehensive security guidance for Costa del Sol property owners from Cenit Security.',
  keywords: 'beachfront property security considerations, property security, costa del sol, spain',
};

export default function BeachfrontPropertySecurityPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-8">
          Beachfront Property Security Considerations
        </h1>
