...
export const metadata: Metadata = {
  title: 'Security Doors for Gyms & Fitness Centres | Cenit Security Costa del Sol',
  description: 'Security Doors for Gyms & Fitness Centres - specialist commercial security solutions for Costa del Sol businesses. Professional installation.',
  keywords: 'security doors for gyms & fitness centres, commercial security doors, costa del sol business security',
};

export default function SecurityDoorsGymsFitnessPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-8">
          Security Doors for Gyms & Fitness Centres
        </h1>
