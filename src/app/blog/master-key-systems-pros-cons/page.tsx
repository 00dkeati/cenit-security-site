...
export const metadata: Metadata = {
  title: 'Master Key Systems: Advantages and Risks | Cenit Security Doors',
  description: 'Expert guide: master key systems: advantages and risks. Professional security door advice from Costa del Sol specialists.',
  keywords: 'master key systems: advantages and risks, security doors spain, costa del sol security',
};

export default function MasterKeySystemsProsConsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Master Key Systems: Advantages and Risks
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about master key systems: advantages and risks.
            </p>
