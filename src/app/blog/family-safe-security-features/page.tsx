...
export const metadata: Metadata = {
  title: 'Family-Safe Security Features | Cenit Security Doors',
  description: 'Expert guide: family-safe security features. Professional security door advice from Costa del Sol specialists.',
  keywords: 'family-safe security features, security doors spain, costa del sol security',
};

export default function FamilySafeSecurityFeaturesPage() {
  return (
        ...
        <article>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about family-safe security features.
            </p>
