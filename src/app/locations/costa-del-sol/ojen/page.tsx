...
export const metadata: Metadata = {
  title: 'Security Doors Ojén | Cenit Security',
  description: 'Professional security door installation in Ojén, Costa del Sol. Bespoke solutions for luxury properties. Free consultation.',
  keywords: 'security doors ojén, ojén security, costa del sol security doors',
};

export default function OjenPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            ...
            Ojén. Our bespoke solutions protect luxury villas and apartments 
            in this prestigious Costa del Sol location.
          </p>
          
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Security Solutions for Ojén
          </h2>
          <p className="text-gray-300 mb-4">
            Ojén features some of the most desirable properties in Costa del Sol, 
          ...
          <p className="text-gray-300 mb-4">
            ...
            common in Ojén, from contemporary villas to traditional estates. 
            We balance robust protection with aesthetic elegance.
          </p>
          
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Our Services in Ojén
          </h2>
          ...
          <p className="text-gray-300 mb-4">
            ...
            understand the specific security requirements of Ojén properties. 
          ...
          <div className="mt-12 p-8 bg-[#1a1a1a] rounded-lg border border-[#c9a961]/20">
            <h3 className="text-2xl font-serif text-[#c9a961] mb-4">
              Free Consultation in Ojén
            </h3>
            <p className="text-gray-300 mb-6">
              Contact us for a free security assessment of your Ojén property. 
