...
export const metadata: Metadata = {
  title: 'Terrace Access Doors Cascada de Camojón | Cenit Security',
  description: 'Professional terrace access doors installation in Cascada de Camojón, Marbella. Bespoke security solutions for luxury properties.',
  keywords: 'terrace access doors cascada de camojón, security doors cascada de camojón, marbella security',
};

export default function TerraceAccessCamojanPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Terrace Access Doors Solutions for Cascada de Camojón
          </h2>
