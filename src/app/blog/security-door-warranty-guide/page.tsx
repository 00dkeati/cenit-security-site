...
export const metadata: Metadata = {
  title: 'Security Door Warranties: What to Look For | Cenit Security Doors',
  description: 'Expert guide: security door warranties: what to look for. Professional security door advice from Costa del Sol specialists.',
  keywords: 'security door warranties: what to look for, security doors spain, costa del sol security',
};

export default function SecurityDoorWarrantyGuidePage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Security Door Warranties: What to Look For
          </h1>
