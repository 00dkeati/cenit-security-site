...
export const metadata: Metadata = {
  title: 'Terrace Access Doors Sotogrande Costa | Cenit Security',
  description: 'Professional terrace access doors installation in Sotogrande Costa, Sotogrande. Bespoke security solutions for luxury properties.',
  keywords: 'terrace access doors sotogrande costa, security doors sotogrande costa, sotogrande security',
};

export default function TerraceAccessSotograndeCostaPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Terrace Access Doors Solutions for Sotogrande Costa
          </h2>
