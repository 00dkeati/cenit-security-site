...
export const metadata = {
  title: "Security Doors Valle Romano, Estepona | Cenit Security Doors",
  description: "Bespoke security doors for Valle Romano properties. Golf resort community. London-standard engineering with discreet installation.",
};

export default function ValleRomanoPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-[#f5f0e8]">
      ...
      <section className="relative h-[60vh] flex items-end">
        <div className="absolute inset-0">
          <Image src="/doors/door-03.jpg" alt="Valle Romano security installation" fill className="object-cover" priority />
        ...
        <div className="relative z-10 w-full pb-16 px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <h1 className="text-5xl md:text-6xl font-light">Valle Romano</h1>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-3 gap-16">
          <div className="lg:col-span-2 space-y-8">
            ...
            <p className="text-2xl font-light leading-relaxed text-[#f5f0e8]/90">
              Golf resort community. Cenit Security Doors provides bespoke security solutions for this prestigious area.
            </p>
            <div className="text-lg text-[#f5f0e8]/70 leading-relaxed space-y-6">
              <p>
                Properties in Valle Romano represent significant investments that deserve protection matching their value. Cenit Security Doors specialises in engineering bespoke security solutions for the unique requirements of this distinguished address.
              </p>
              <p>
                Our installations in Valle Romano encompass front entrance security doors, terrace and secondary access protection, safe room installations, and sophisticated biometric access control systems. Each project is approached with the discretion and precision that residents of Valle Romano expect.
              </p>
              <p>
                We understand the architectural character of Valle Romano and ensure every security installation complements your property&apos;s aesthetic whilst providing certified protection against forced entry.
              </p>
            </div>

            <div className="pt-8 border-t border-[#2a2a2a]">
              <h2 className="text-2xl font-light mb-6">Security Services in Valle Romano</h2>
          ...
          <div className="space-y-6">
            <div className="bg-[#1a1a1a] p-8">
              ...
              <p className="text-[#f5f0e8]/70 leading-relaxed">Valle Romano is located within Estepona, one of the Costa del Sol&apos;s most sought-after areas.</p>
            </div>
            <a 
              href="https://wa.me/34667793100?text=Hello%2C%20I%27m%20interested%20in%20security%20doors%20for%20my%20property%20in%20Valle%20Romano"
              target="_blank"
