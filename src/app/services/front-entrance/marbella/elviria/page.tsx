...
export const metadata = {
  title: "Front Entrance Elviria | Cenit Security Doors",
  description: "Front Entrance Security Doors for properties in Elviria, Marbella. Bespoke security engineering with discreet installation.",
};
    ...
    <main className="min-h-screen bg-[#0f0f0f] text-[#f5f0e8]">
      ...
      <section className="relative h-[60vh] flex items-end">
        <div className="absolute inset-0">
          <Image src="/doors/door-04.jpg" alt="Front Entrance Elviria" fill className="object-cover" priority />
      ...
      <section className="py-20 px-8">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <p className="text-2xl font-light leading-relaxed text-[#f5f0e8]/90">
            Specialist front entrance security doors for Elviria properties.
          </p>
          <div className="text-lg text-[#f5f0e8]/70 leading-relaxed space-y-6">
            <p>
              Elviria is one of the most prestigious addresses in Marbella. Properties here demand front entrance security doors that match their exceptional standards.
            </p>
            <p>
              Cenit Security Doors provides bespoke front entrance security doors throughout Elviria, working with homeowners and architects to deliver solutions that integrate seamlessly with each property&apos;s unique character.
            </p>
            <p>
              Every installation is handled with the discretion and precision that Elviria residents expect. Contact us to arrange a private consultation.
            </p>
          </div>
          <a 
            href="https://wa.me/34667793100?text=Hello%2C%20I%27m%20interested%20in%20front%20entrance%20security%20doors%20for%20my%20property%20in%20Elviria"
            target="_blank"
