...
export const metadata: Metadata = {
  title: 'Complete Guide to Villa Security in Spain | Cenit Security Doors',
  description: 'Complete Guide to Villa Security in Spain - comprehensive security guidance for Costa del Sol property owners from Cenit Security.',
  keywords: 'complete guide to villa security in spain, property security, costa del sol, spain',
};

export default function CompleteGuideVillaSecuritySpainPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-8">
          Complete Guide to Villa Security in Spain
        </h1>
