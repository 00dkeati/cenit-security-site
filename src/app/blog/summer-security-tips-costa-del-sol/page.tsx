...
export const metadata: Metadata = {
  title: 'Summer Security Tips for Costa del Sol Properties | Cenit Security Doors',
  description: 'Expert guide: summer security tips for costa del sol properties. Professional security door advice from Costa del Sol specialists.',
  keywords: 'summer security tips for costa del sol properties, security doors spain, costa del sol security',
};

export default function SummerSecurityTipsCostaDelSolPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Summer Security Tips for Costa del Sol Properties
          </h1>
          
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Security needs change throughout the year, especially for properties that may be unoccupied during certain seasons. This guide helps you prepare for these variations.
            </p>
