...
export const metadata: Metadata = {
  title: 'Security for Estepona New Developments | Cenit Security Doors',
  description: 'Expert guide: security for estepona new developments. Professional security door advice from Costa del Sol specialists.',
  keywords: 'security for estepona new developments, security doors spain, costa del sol security',
};

export default function EsteponaNewDevelopmentsSecurityPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Security for Estepona New Developments
          </h1>
