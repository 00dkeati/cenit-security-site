...
export const metadata: Metadata = {
  title: 'Top Rated Security Doors in Spain | Cenit Security',
  description: 'Top Rated Security Doors in Spain. Professional security door installation and service. Free consultation available.',
  keywords: 'top rated security doors in spain, security doors spain, local security installer',
};

export default function TopRatedSecurityDoorsSpainPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <p className="text-gray-300 mb-4">
            As a Spain-based security company, we understand the specific needs 
          ...
          <p className="text-gray-300 mb-4">
            We've installed security doors throughout Spain for villas, 
