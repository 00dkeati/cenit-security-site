...
export const metadata: Metadata = {
  title: 'Security Doors Nerja | Cenit Security',
  description: 'Professional security door installation in Nerja, Costa del Sol. Bespoke solutions for luxury properties. Free consultation.',
  keywords: 'security doors nerja, nerja security, costa del sol security doors',
};
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          <p className="text-xl text-gray-300 mb-8 leading-relaxed">
            ...
            Nerja. Our bespoke solutions protect luxury villas and apartments 
            in this prestigious Costa del Sol location.
          </p>
          
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Security Solutions for Nerja
          </h2>
          <p className="text-gray-300 mb-4">
            Nerja features some of the most desirable properties in Costa del Sol, 
          ...
          <p className="text-gray-300 mb-4">
            ...
            common in Nerja, from contemporary villas to traditional estates. 
            We balance robust protection with aesthetic elegance.
          </p>
          
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Our Services in Nerja
          </h2>
          ...
          <p className="text-gray-300 mb-4">
            ...
            understand the specific security requirements of Nerja properties. 
          ...
          <div className="mt-12 p-8 bg-[#1a1a1a] rounded-lg border border-[#c9a961]/20">
            <h3 className="text-2xl font-serif text-[#c9a961] mb-4">
              Free Consultation in Nerja
            </h3>
            <p className="text-gray-300 mb-6">
              Contact us for a free security assessment of your Nerja property. 
