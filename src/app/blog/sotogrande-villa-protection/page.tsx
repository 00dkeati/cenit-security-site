...
export const metadata: Metadata = {
  title: 'Sotogrande Villa Protection: What You Need | Cenit Security Doors',
  description: 'Expert guide: sotogrande villa protection: what you need. Professional security door advice from Costa del Sol specialists.',
  keywords: 'sotogrande villa protection: what you need, security doors spain, costa del sol security',
};

export default function SotograndeVillaProtectionPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Sotogrande Villa Protection: What You Need
          </h1>
