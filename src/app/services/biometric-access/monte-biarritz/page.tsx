...
export const metadata: Metadata = {
  title: 'Biometric Access Systems Monte Biarritz | Cenit Security',
  description: 'Professional biometric access systems installation in Monte Biarritz, Estepona. Bespoke security solutions for luxury properties.',
  keywords: 'biometric access systems monte biarritz, security doors monte biarritz, estepona security',
};

export default function BiometricAccessMonteBiarritzPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Biometric Access Systems Solutions for Monte Biarritz
          </h2>
