...
export const metadata: Metadata = {
  title: 'Biometric Access Systems Rincón de la Victoria | Cenit Security',
  description: 'Professional biometric access systems installation in Rincón de la Victoria, Costa del Sol. Bespoke security solutions for luxury properties.',
  keywords: 'biometric access systems rincón de la victoria, security doors rincón de la victoria, costa del sol security',
};

export default function BiometricAccessRinconDeLaVictoriaPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Biometric Access Systems Solutions for Rincón de la Victoria
          </h2>
