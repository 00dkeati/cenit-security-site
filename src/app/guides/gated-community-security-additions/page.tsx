...
export const metadata: Metadata = {
  title: 'Additional Security for Gated Community Homes | Cenit Security Doors',
  description: 'Additional Security for Gated Community Homes - comprehensive security guidance for Costa del Sol property owners from Cenit Security.',
  keywords: 'additional security for gated community homes, property security, costa del sol, spain',
};

export default function GatedCommunitySecurityAdditionsPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-8">
          Additional Security for Gated Community Homes
        </h1>
