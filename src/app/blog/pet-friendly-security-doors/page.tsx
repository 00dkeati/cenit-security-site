...
export const metadata: Metadata = {
  title: 'Pet-Friendly Security Door Options | Cenit Security Doors',
  description: 'Expert guide: pet-friendly security door options. Professional security door advice from Costa del Sol specialists.',
  keywords: 'pet-friendly security door options, security doors spain, costa del sol security',
};

export default function PetFriendlySecurityDoorsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Pet-Friendly Security Door Options
          </h1>
