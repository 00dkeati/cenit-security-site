...
export const metadata: Metadata = {
  title: 'Biometric Access Systems Coín | Cenit Security',
  description: 'Professional biometric access systems installation in Coín, Costa del Sol. Bespoke security solutions for luxury properties.',
  keywords: 'biometric access systems coín, security doors coín, costa del sol security',
};

export default function BiometricAccessCoinPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Biometric Access Systems Solutions for Coín
          </h2>
