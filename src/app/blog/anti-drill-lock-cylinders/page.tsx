...
export const metadata: Metadata = {
  title: 'Anti-Drill Lock Cylinders: Essential Protection | Cenit Security Doors',
  description: 'Expert guide: anti-drill lock cylinders: essential protection. Professional security door advice from Costa del Sol specialists.',
  keywords: 'anti-drill lock cylinders: essential protection, security doors spain, costa del sol security',
};

export default function AntiDrillLockCylindersPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Anti-Drill Lock Cylinders: Essential Protection
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about anti-drill lock cylinders: essential protection.
            </p>
