...
export const metadata: Metadata = {
  title: 'Electronic vs Mechanical Locks: Making the Right Choice | Cenit Security Doors',
  description: 'Expert guide: electronic vs mechanical locks: making the right choice. Professional security door advice from Costa del Sol specialists.',
  keywords: 'electronic vs mechanical locks: making the right choice, security doors spain, costa del sol security',
};

export default function ElectronicVsMechanicalLocksPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Electronic vs Mechanical Locks: Making the Right Choice
          </h1>
