...
export const metadata: Metadata = {
  title: 'Sliding vs Swing Security Doors | Cenit Security',
  description: 'Detailed comparison: sliding vs swing security doors. Expert analysis to help Costa del Sol property owners choose.',
  keywords: 'sliding vs swing security doors, security comparison, costa del sol',
};

export default function SlidingVsSwingSecurityDoorsPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-8">
          Sliding vs Swing Security Doors
        </h1>
