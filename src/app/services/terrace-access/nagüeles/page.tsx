...
export const metadata: Metadata = {
  title: 'Terrace Access Doors Nagüeles | Cenit Security',
  description: 'Professional terrace access doors installation in Nagüeles, Marbella. Bespoke security solutions for luxury properties.',
  keywords: 'terrace access doors nagüeles, security doors nagüeles, marbella security',
};

export default function TerraceAccessNagüelesPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Terrace Access Doors Solutions for Nagüeles
          </h2>
