...
export const metadata: Metadata = {
  title: 'Safe Room Installation Monte Biarritz | Cenit Security',
  description: 'Professional safe room installation installation in Monte Biarritz, Estepona. Bespoke security solutions for luxury properties.',
  keywords: 'safe room installation monte biarritz, security doors monte biarritz, estepona security',
};

export default function SafeRoomsMonteBiarritzPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Safe Room Installation Solutions for Monte Biarritz
          </h2>
