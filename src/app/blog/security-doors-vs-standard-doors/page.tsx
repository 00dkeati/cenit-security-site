...
export const metadata: Metadata = {
  title: 'Security Doors vs Standard Doors: Key Differences | Cenit Security Doors',
  description: 'Expert guide: security doors vs standard doors: key differences. Professional security door advice from Costa del Sol specialists.',
  keywords: 'security doors vs standard doors: key differences, security doors spain, costa del sol security',
};

export default function SecurityDoorsVsStandardDoorsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Security Doors vs Standard Doors: Key Differences
          </h1>
