...
export const metadata: Metadata = {
  title: 'Smart Home Security Integration Guide | Cenit Security Doors',
  description: 'Expert guide: smart home security integration guide. Professional security door advice from Costa del Sol specialists.',
  keywords: 'smart home security integration guide, security doors spain, costa del sol security',
};

export default function SmartHomeSecurityIntegrationPage() {
  return (
