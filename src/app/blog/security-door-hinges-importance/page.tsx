...
export const metadata: Metadata = {
  title: 'Why Security Door Hinges Matter | Cenit Security Doors',
  description: 'Expert guide: why security door hinges matter. Professional security door advice from Costa del Sol specialists.',
  keywords: 'why security door hinges matter, security doors spain, costa del sol security',
};

export default function SecurityDoorHingesImportancePage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Why Security Door Hinges Matter
          </h1>
