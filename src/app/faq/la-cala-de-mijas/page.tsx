...
export const metadata: Metadata = {
  title: 'Security Doors FAQ La Cala de Mijas | Cenit Security',
  description: 'Frequently asked questions about security doors in La Cala de Mijas, Costa del Sol. Expert answers from Cenit Security.',
  keywords: 'security doors faq, la cala de mijas security, questions security doors',
};

export default function FAQLaCalaDeMijasPage() {
  const faqs = [
    {
    ...
    },
    {
        ...
        "a": "Yes, we serve all areas of the Costa del Sol including La Cala de Mijas and surrounding regions. Our team handles installations from Sotogrande to Málaga."
    },
    {
  ...
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        <div className="mb-8">
          <Link href="/locations/la-cala-de-mijas" className="text-[#c9a961] hover:underline">
            ← Back to La Cala de Mijas
          </Link>
        </div>
        ...
        <h2 className="text-2xl text-gray-400 mb-12">La Cala de Mijas, Costa del Sol</h2>
        ...
        <div className="mt-12 p-8 bg-[#1a1a1a] rounded-lg border border-[#c9a961]/20">
          ...
          <p className="text-gray-300 mb-6">
            ...
            for your La Cala de Mijas property.
          </p>
          <a
