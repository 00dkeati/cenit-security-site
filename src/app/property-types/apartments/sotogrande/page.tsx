...
export const metadata = {
  title: "Security Doors for Apartments & Penthouses in Sotogrande | Cenit Security Doors",
  description: "Security doors for high-rise luxury living in Sotogrande. London-standard security engineering for Costa del Sol properties.",
};
    ...
    <main className="min-h-screen bg-[#0f0f0f] text-[#f5f0e8]">
      ...
      <section className="relative h-[60vh] flex items-end">
        <div className="absolute inset-0">
          <Image src="/doors/door-05.jpg" alt="Apartments & Penthouses security in Sotogrande" fill className="object-cover" priority />
        ...
        <div className="relative z-10 w-full pb-16 px-8">
          <div className="max-w-7xl mx-auto">
            <Link href="/locations/sotogrande" className="inline-flex items-center gap-2 font-sans text-xs tracking-[0.2em] uppercase text-[#c9a961] mb-4">
      ...
      <section className="py-20 px-8">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <p className="text-2xl font-light leading-relaxed text-[#f5f0e8]/90">
            Security doors for high-rise luxury living across Sotogrande.
          </p>
          <div className="text-lg text-[#f5f0e8]/70 leading-relaxed space-y-6">
            <p>
              apartments & penthouses in Sotogrande present unique security challenges and opportunities. Cenit Security Doors specialises in engineering bespoke solutions that address the specific requirements of apartments & penthouses.
            </p>
            <p>
            ...
            <p>
              Contact us to discuss your apartments & penthouses security requirements in Sotogrande.
            </p>
          </div>
          <a 
            href="https://wa.me/34667793100?text=Hello%2C%20I%27m%20interested%20in%20security%20doors%20for%20my%20apartments%20%26%20penthouses%20in%20Sotogrande"
            target="_blank"
