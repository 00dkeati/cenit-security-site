...
export const metadata: Metadata = {
  title: 'How Much Do Security Doors Cost in Spain? | Cenit Security Doors',
  description: 'Expert guide: how much do security doors cost in spain?. Professional security door advice from Costa del Sol specialists.',
  keywords: 'how much do security doors cost in spain?, security doors spain, costa del sol security',
};

export default function HowMuchDoSecurityDoorsCostPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            How Much Do Security Doors Cost in Spain?
          </h1>
