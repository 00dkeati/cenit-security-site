...
export const metadata: Metadata = {
  title: 'Security Doors for Retail Shops | Cenit Security Costa del Sol',
  description: 'Security Doors for Retail Shops - specialist commercial security solutions for Costa del Sol businesses. Professional installation.',
  keywords: 'security doors for retail shops, commercial security doors, costa del sol business security',
};

export default function SecurityDoorsRetailShopsPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-8">
          Security Doors for Retail Shops
        </h1>
