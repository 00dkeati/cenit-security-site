...
export const metadata: Metadata = {
  title: 'Temporary Access Codes for Guests and Services | Cenit Security Doors',
  description: 'Expert guide: temporary access codes for guests and services. Professional security door advice from Costa del Sol specialists.',
  keywords: 'temporary access codes for guests and services, security doors spain, costa del sol security',
};

export default function TemporaryAccessCodesPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Temporary Access Codes for Guests and Services
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about temporary access codes for guests and services.
            </p>
