...
export const metadata = {
  title: "Front Entrance in New Golden Mile, Estepona | Cenit Security Doors",
  description: "Front Entrance Security Doors for luxury properties in New Golden Mile. London-standard security engineering with bespoke design and discreet installation across Estepona.",
  keywords: "front entrance security doors, New Golden Mile, Estepona, security doors, Costa del Sol, luxury security",
};
    ...
    <main className="min-h-screen bg-[#0f0f0f] text-[#f5f0e8]">
      ...
      <section className="relative h-[60vh] flex items-end">
        <div className="absolute inset-0">
          <Image src="/doors/door-07.jpg" alt="Front Entrance in New Golden Mile" fill className="object-cover" priority />
        ...
        <div className="relative z-10 w-full pb-16 px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-light">Front Entrance in New Golden Mile</h1>
          ...
          <div className="grid lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2 space-y-8">
              ...
              <h2 className="text-3xl font-light leading-relaxed text-[#f5f0e8]/90">
                Expert Front Entrance Security Doors for New Golden Mile Properties
              </h2>
              <div className="text-lg text-[#f5f0e8]/70 leading-relaxed space-y-6">
                <p>Front entrance security is paramount for New Golden Mile properties. As the primary point of entry, your front door must project prestige while providing certified protection against forced entry. Cenit Security Doors engineers bespoke entrance solutions that achieve both objectives.</p>
                <p>
            ...
            <div className="space-y-6">
              ...
              <a 
                href="https://wa.me/34667793100?text=Hello%2C%20I%27m%20interested%20in%20front%20entrance%20security%20doors%20for%20my%20property%20in%20New%20Golden%20Mile%2C%20Estepona"
                target="_blank"
