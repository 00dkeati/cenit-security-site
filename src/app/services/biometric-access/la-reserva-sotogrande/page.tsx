...
export const metadata: Metadata = {
  title: 'Biometric Access Systems La Reserva Sotogrande | Cenit Security',
  description: 'Professional biometric access systems installation in La Reserva Sotogrande, Sotogrande. Bespoke security solutions for luxury properties.',
  keywords: 'biometric access systems la reserva sotogrande, security doors la reserva sotogrande, sotogrande security',
};

export default function BiometricAccessLaReservaSotograndePage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Biometric Access Systems Solutions for La Reserva Sotogrande
          </h2>
