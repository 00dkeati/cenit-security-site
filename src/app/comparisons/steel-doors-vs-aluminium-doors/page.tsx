...
export const metadata: Metadata = {
  title: 'Steel Security Doors vs Aluminium | Cenit Security',
  description: 'Detailed comparison: steel security doors vs aluminium. Expert analysis to help Costa del Sol property owners choose.',
  keywords: 'steel security doors vs aluminium, security comparison, costa del sol',
};

export default function SteelDoorsVsAluminiumDoorsPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-8">
          Steel Security Doors vs Aluminium
        </h1>
