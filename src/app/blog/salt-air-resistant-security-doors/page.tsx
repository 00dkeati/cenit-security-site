...
export const metadata: Metadata = {
  title: 'Salt Air Resistant Security Doors for Beachfront | Cenit Security Doors',
  description: 'Expert guide: salt air resistant security doors for beachfront. Professional security door advice from Costa del Sol specialists.',
  keywords: 'salt air resistant security doors for beachfront, security doors spain, costa del sol security',
};

export default function SaltAirResistantSecurityDoorsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Salt Air Resistant Security Doors for Beachfront
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about salt air resistant security doors for beachfront.
            </p>
