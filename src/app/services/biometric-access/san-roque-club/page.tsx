...
export const metadata: Metadata = {
  title: 'Biometric Access Systems San Roque Club | Cenit Security',
  description: 'Professional biometric access systems installation in San Roque Club, Sotogrande. Bespoke security solutions for luxury properties.',
  keywords: 'biometric access systems san roque club, security doors san roque club, sotogrande security',
};

export default function BiometricAccessSanRoqueClubPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Biometric Access Systems Solutions for San Roque Club
          </h2>
