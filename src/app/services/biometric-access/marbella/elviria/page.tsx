...
export const metadata = {
  title: "Biometric Access Elviria | Cenit Security Doors",
  description: "Biometric Access Control for properties in Elviria, Marbella. Bespoke security engineering with discreet installation.",
};
    ...
    <main className="min-h-screen bg-[#0f0f0f] text-[#f5f0e8]">
      ...
      <section className="relative h-[60vh] flex items-end">
        <div className="absolute inset-0">
          <Image src="/doors/door-05.jpg" alt="Biometric Access Elviria" fill className="object-cover" priority />
      ...
      <section className="py-20 px-8">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <p className="text-2xl font-light leading-relaxed text-[#f5f0e8]/90">
            Specialist biometric access control for Elviria properties.
          </p>
          <div className="text-lg text-[#f5f0e8]/70 leading-relaxed space-y-6">
            <p>
              Elviria is one of the most prestigious addresses in Marbella. Properties here demand biometric access control that match their exceptional standards.
            </p>
            <p>
              Cenit Security Doors provides bespoke biometric access control throughout Elviria, working with homeowners and architects to deliver solutions that integrate seamlessly with each property&apos;s unique character.
            </p>
            <p>
          ...
          <a 
            href="https://wa.me/34667793100?text=Hello%2C%20I%27m%20interested%20in%20biometric%20access%20control%20for%20my%20property%20in%20Elviria"
            target="_blank"
