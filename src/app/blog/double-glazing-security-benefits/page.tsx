...
export const metadata: Metadata = {
  title: 'Double Glazing Security Benefits | Cenit Security Doors',
  description: 'Expert guide: double glazing security benefits. Professional security door advice from Costa del Sol specialists.',
  keywords: 'double glazing security benefits, security doors spain, costa del sol security',
};

export default function DoubleGlazingSecurityBenefitsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Double Glazing Security Benefits
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about double glazing security benefits.
            </p>
