...
export const metadata: Metadata = {
  title: 'Terrace Access Doors Guadalmina Alta | Cenit Security',
  description: 'Professional terrace access doors installation in Guadalmina Alta, San Pedro de Alcántara. Bespoke security solutions for luxury properties.',
  keywords: 'terrace access doors guadalmina alta, security doors guadalmina alta, san pedro de alcántara security',
};

export default function TerraceAccessGuadalminaAltaPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Terrace Access Doors Solutions for Guadalmina Alta
          </h2>
