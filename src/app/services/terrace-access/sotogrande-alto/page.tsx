...
export const metadata: Metadata = {
  title: 'Terrace Access Doors Sotogrande Alto | Cenit Security',
  description: 'Professional terrace access doors installation in Sotogrande Alto, Sotogrande. Bespoke security solutions for luxury properties.',
  keywords: 'terrace access doors sotogrande alto, security doors sotogrande alto, sotogrande security',
};

export default function TerraceAccessSotograndeAltoPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Terrace Access Doors Solutions for Sotogrande Alto
          </h2>
