...
export const metadata: Metadata = {
  title: 'Security Doors vs Security Grilles | Cenit Security',
  description: 'Detailed comparison: security doors vs security grilles. Expert analysis to help Costa del Sol property owners choose.',
  keywords: 'security doors vs security grilles, security comparison, costa del sol',
};

export default function SecurityDoorsVsSecurityGrillesPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-8">
          Security Doors vs Security Grilles
        </h1>
