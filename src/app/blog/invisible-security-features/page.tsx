...
export const metadata: Metadata = {
  title: 'Invisible Security: Protecting Without Showing | Cenit Security Doors',
  description: 'Expert guide: invisible security: protecting without showing. Professional security door advice from Costa del Sol specialists.',
  keywords: 'invisible security: protecting without showing, security doors spain, costa del sol security',
};

export default function InvisibleSecurityFeaturesPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Invisible Security: Protecting Without Showing
          </h1>
