...
export const metadata: Metadata = {
  title: 'Best Security Doors in Marbella | Cenit Security',
  description: 'Best Security Doors in Marbella. Professional security door installation and service. Free consultation available.',
  keywords: 'best security doors in marbella, security doors marbella, local security installer',
};

export default function BestSecurityDoorsMarbellaPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-4">
          Best Security Doors in Marbella
        </h1>
