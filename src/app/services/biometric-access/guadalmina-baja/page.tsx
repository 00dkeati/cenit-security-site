...
export const metadata: Metadata = {
  title: 'Biometric Access Systems Guadalmina Baja | Cenit Security',
  description: 'Professional biometric access systems installation in Guadalmina Baja, San Pedro de Alcántara. Bespoke security solutions for luxury properties.',
  keywords: 'biometric access systems guadalmina baja, security doors guadalmina baja, san pedro de alcántara security',
};

export default function BiometricAccessGuadalminaBajaPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Biometric Access Systems Solutions for Guadalmina Baja
          </h2>
