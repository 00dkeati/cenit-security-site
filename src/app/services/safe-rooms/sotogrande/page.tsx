...
export const metadata = {
  title: "Safe Rooms & Panic Rooms in Sotogrande | Cenit Security Doors",
  description: "Safe Rooms & Panic Rooms for luxury properties in Sotogrande. London-standard security engineering with bespoke design and discreet installation.",
};

export default function SafeRoomsSotograndePage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-[#f5f0e8]">
      ...
      <section className="relative h-[60vh] flex items-end">
        <div className="absolute inset-0">
          <Image src="/doors/door-01.jpg" alt="Safe Rooms in Sotogrande" fill className="object-cover" priority />
        ...
        <div className="relative z-10 w-full pb-16 px-8">
          <div className="max-w-7xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-light">Safe Rooms in Sotogrande</h1>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-3 gap-16">
          <div className="lg:col-span-2 space-y-8">
            ...
            <p className="text-2xl font-light leading-relaxed text-[#f5f0e8]/90">
              Specialist safe rooms & panic rooms for luxury properties throughout Sotogrande.
            </p>
            <div className="text-lg text-[#f5f0e8]/70 leading-relaxed space-y-6">
              <p>
                Cenit Security Doors provides bespoke safe rooms & panic rooms across Sotogrande, from initial consultation through to installation and commissioning. Our solutions are engineered to the highest standards whilst complementing the architectural character of your property.
              </p>
              <p>
                Sotogrande properties demand security solutions that match their prestige. We work with homeowners, architects, and developers to deliver safe rooms & panic rooms that provide certified protection without compromising on aesthetics.
              </p>
              <p>
          ...
          <div className="space-y-6">
            ...
            <a 
              href="https://wa.me/34667793100?text=Hello%2C%20I%27m%20interested%20in%20safe%20rooms%20%26%20panic%20rooms%20for%20my%20property%20in%20Sotogrande"
              target="_blank"
