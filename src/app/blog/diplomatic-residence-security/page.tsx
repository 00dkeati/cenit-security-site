...
export const metadata: Metadata = {
  title: 'Security Standards for Diplomatic Residences | Cenit Security Doors',
  description: 'Expert guide: security standards for diplomatic residences. Professional security door advice from Costa del Sol specialists.',
  keywords: 'security standards for diplomatic residences, security doors spain, costa del sol security',
};

export default function DiplomaticResidenceSecurityPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Security Standards for Diplomatic Residences
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about security standards for diplomatic residences.
            </p>
