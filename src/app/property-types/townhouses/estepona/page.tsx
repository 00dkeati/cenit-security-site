...
export const metadata = {
  title: "Security Doors for Townhouses in Estepona | Cenit Security Doors",
  description: "Security solutions for exclusive townhouse communities in Estepona. London-standard security engineering for Costa del Sol properties.",
};
    ...
    <main className="min-h-screen bg-[#0f0f0f] text-[#f5f0e8]">
      ...
      <section className="relative h-[60vh] flex items-end">
        <div className="absolute inset-0">
          <Image src="/doors/door-08.jpg" alt="Townhouses security in Estepona" fill className="object-cover" priority />
      ...
      <section className="py-20 px-8">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <p className="text-2xl font-light leading-relaxed text-[#f5f0e8]/90">
            Security solutions for exclusive townhouse communities across Estepona.
          </p>
          <div className="text-lg text-[#f5f0e8]/70 leading-relaxed space-y-6">
            <p>
              townhouses in Estepona present unique security challenges and opportunities. Cenit Security Doors specialises in engineering bespoke solutions that address the specific requirements of townhouses.
            </p>
            <p>
            ...
            <p>
              Contact us to discuss your townhouses security requirements in Estepona.
            </p>
          </div>
          <a 
            href="https://wa.me/34667793100?text=Hello%2C%20I%27m%20interested%20in%20security%20doors%20for%20my%20townhouses%20in%20Estepona"
            target="_blank"
