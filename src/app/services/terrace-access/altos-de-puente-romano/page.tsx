...
export const metadata: Metadata = {
  title: 'Terrace Access Doors Altos de Puente Romano | Cenit Security',
  description: 'Professional terrace access doors installation in Altos de Puente Romano, Marbella. Bespoke security solutions for luxury properties.',
  keywords: 'terrace access doors altos de puente romano, security doors altos de puente romano, marbella security',
};

export default function TerraceAccessAltosDePuenteRomanoPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Terrace Access Doors Solutions for Altos de Puente Romano
          </h2>
