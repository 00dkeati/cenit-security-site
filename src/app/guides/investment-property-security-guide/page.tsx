...
export const metadata: Metadata = {
  title: 'Investment Property Security Guide | Cenit Security Doors',
  description: 'Investment Property Security Guide - comprehensive security guidance for Costa del Sol property owners from Cenit Security.',
  keywords: 'investment property security guide, property security, costa del sol, spain',
};

export default function InvestmentPropertySecurityGuidePage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-8">
          Investment Property Security Guide
        </h1>
