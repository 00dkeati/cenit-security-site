...
export const metadata: Metadata = {
  title: 'Best Security Doors for 2026 | Cenit Security Doors',
  description: 'Expert guide: best security doors for 2026. Professional security door advice from Costa del Sol specialists.',
  keywords: 'best security doors for 2026, security doors spain, costa del sol security',
};

export default function BestSecurityDoors2026Page() {
  return (
        ...
        <article>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about best security doors for 2026.
            </p>
