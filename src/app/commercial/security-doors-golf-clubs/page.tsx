...
export const metadata: Metadata = {
  title: 'Security Doors for Golf Clubs | Cenit Security Costa del Sol',
  description: 'Security Doors for Golf Clubs - specialist commercial security solutions for Costa del Sol businesses. Professional installation.',
  keywords: 'security doors for golf clubs, commercial security doors, costa del sol business security',
};

export default function SecurityDoorsGolfClubsPage() {
  return (
