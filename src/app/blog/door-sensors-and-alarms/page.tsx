...
export const metadata: Metadata = {
  title: 'Door Sensors and Alarms Integration Guide | Cenit Security Doors',
  description: 'Expert guide: door sensors and alarms integration guide. Professional security door advice from Costa del Sol specialists.',
  keywords: 'door sensors and alarms integration guide, security doors spain, costa del sol security',
};

export default function DoorSensorsAndAlarmsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Door Sensors and Alarms Integration Guide
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about door sensors and alarms integration guide.
            </p>
