...
export const metadata: Metadata = {
  title: 'Soundproof Security Doors for Ultimate Privacy | Cenit Security Doors',
  description: 'Expert guide: soundproof security doors for ultimate privacy. Professional security door advice from Costa del Sol specialists.',
  keywords: 'soundproof security doors for ultimate privacy, security doors spain, costa del sol security',
};

export default function SoundproofSecurityDoorsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Soundproof Security Doors for Ultimate Privacy
          </h1>
