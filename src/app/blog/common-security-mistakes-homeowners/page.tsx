...
export const metadata: Metadata = {
  title: 'Common Security Mistakes Homeowners Make | Cenit Security Doors',
  description: 'Expert guide: common security mistakes homeowners make. Professional security door advice from Costa del Sol specialists.',
  keywords: 'common security mistakes homeowners make, security doors spain, costa del sol security',
};

export default function CommonSecurityMistakesHomeownersPage() {
  return (
        ...
        <article>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              When it comes to protecting your property on the Costa del Sol, making informed decisions is crucial. This guide covers everything you need to know about common security mistakes homeowners make, helping you make the right choice for your home security needs.
            </p>
