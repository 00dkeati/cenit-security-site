...
export const metadata: Metadata = {
  title: 'Security Doors for New Build Properties in Spain | Cenit Security Doors',
  description: 'Expert guide: security doors for new build properties in spain. Professional security door advice from Costa del Sol specialists.',
  keywords: 'security doors for new build properties in spain, security doors spain, costa del sol security',
};

export default function SecurityDoorsForNewBuildsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Security Doors for New Build Properties in Spain
          </h1>
          
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              When it comes to protecting your property on the Costa del Sol, making informed decisions is crucial. This guide covers everything you need to know about security doors for new build properties in spain, helping you make the right choice for your home security needs.
            </p>
