...
export const metadata: Metadata = {
  title: 'Top Luxury Security Door Brands Compared | Cenit Security Doors',
  description: 'Expert guide: top luxury security door brands compared. Professional security door advice from Costa del Sol specialists.',
  keywords: 'top luxury security door brands compared, security doors spain, costa del sol security',
};

export default function LuxuryDoorBrandsComparisonPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Top Luxury Security Door Brands Compared
          </h1>
          ...
          <div className="prose prose-invert prose-lg max-w-none">
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              ...
              need to know about top luxury security door brands compared.
            </p>
