...
export const metadata: Metadata = {
  title: 'Security Door Locking Mechanisms Explained | Cenit Security Doors',
  description: 'Expert guide: security door locking mechanisms explained. Professional security door advice from Costa del Sol specialists.',
  keywords: 'security door locking mechanisms explained, security doors spain, costa del sol security',
};

export default function SecurityDoorLockingMechanismsPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Security Door Locking Mechanisms Explained
          </h1>
