...
export const metadata: Metadata = {
  title: 'Biometric vs Keypad Access Control: Which is Better? | Cenit Security Doors',
  description: 'Expert guide: biometric vs keypad access control: which is better?. Professional security door advice from Costa del Sol specialists.',
  keywords: 'biometric vs keypad access control: which is better?, security doors spain, costa del sol security',
};

export default function BiometricVsKeypadAccessControlPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <article>
          <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-6">
            Biometric vs Keypad Access Control: Which is Better?
          </h1>
