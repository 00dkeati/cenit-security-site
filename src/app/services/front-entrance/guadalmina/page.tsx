...
export const metadata: Metadata = {
  title: 'Front Entrance Doors Guadalmina | Cenit Security',
  description: 'Professional front entrance doors installation in Guadalmina, Marbella. Bespoke security solutions for luxury properties.',
  keywords: 'front entrance doors guadalmina, security doors guadalmina, marbella security',
};

export default function FrontEntranceGuadalminaPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Front Entrance Doors Solutions for Guadalmina
          </h2>
