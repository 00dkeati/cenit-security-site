...
export const metadata: Metadata = {
  title: 'Biometric Access Systems Alhaurín el Grande | Cenit Security',
  description: 'Professional biometric access systems installation in Alhaurín el Grande, Costa del Sol. Bespoke security solutions for luxury properties.',
  keywords: 'biometric access systems alhaurín el grande, security doors alhaurín el grande, costa del sol security',
};

export default function BiometricAccessAlhaurinElGrandePage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Biometric Access Systems Solutions for Alhaurín el Grande
          </h2>
