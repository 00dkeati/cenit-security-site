...
export const metadata: Metadata = {
  title: 'Safe Room Installation Nueva Andalucía | Cenit Security',
  description: 'Professional safe room installation installation in Nueva Andalucía, Marbella. Bespoke security solutions for luxury properties.',
  keywords: 'safe room installation nueva andalucía, security doors nueva andalucía, marbella security',
};

export default function SafeRoomsNuevaAndaluciaPage() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <h2 className="text-2xl font-serif text-[#c9a961] mt-12 mb-4">
            Safe Room Installation Solutions for Nueva Andalucía
          </h2>
