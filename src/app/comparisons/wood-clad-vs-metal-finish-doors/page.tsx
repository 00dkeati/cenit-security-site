...
export const metadata: Metadata = {
  title: 'Wood-Clad vs Metal Finish Security Doors | Cenit Security',
  description: 'Detailed comparison: wood-clad vs metal finish security doors. Expert analysis to help Costa del Sol property owners choose.',
  keywords: 'wood-clad vs metal finish security doors, security comparison, costa del sol',
};

export default function WoodCladVsMetalFinishDoorsPage() {
  return (
    <main className="min-h-screen bg-[#0f0f0f] text-white">
      <div className="max-w-4xl mx-auto px-4 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-serif text-[#c9a961] mb-8">
          Wood-Clad vs Metal Finish Security Doors
        </h1>
